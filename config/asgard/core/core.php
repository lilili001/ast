...
return [
   ...
   */
    'admin-assets' => [
        ...
        'dataTables.bootstrap.css' => ['theme' => 'vendor/datatables.net-bs/css/dataTables.bootstrap.css'],
        ...
        'jquery.dataTables.js' => ['theme' => 'vendor/datatables.net/js/jquery.dataTables.js'],
        'dataTables.bootstrap.js' => ['theme' => 'vendor/datatables.net-bs/js/dataTables.bootstrap.js'],
