...
-- ----------------------------
-- Table structure for currency__currency_translations
-- ----------------------------
DROP TABLE IF EXISTS `currency__currency_translations`;
CREATE TABLE `currency__currency_translations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `currency_id` int(10) unsigned NOT NULL,
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `currency__currency_translations_currency_id_locale_unique` (`currency_id`,`locale`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of currency__currency_translations
-- ----------------------------
...
INSERT INTO `migrations` VALUES ('80', '2018_05_17_014721864276_create_currency_currencies_table', '14');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', '2861166132@qq.com', '$2y$10$QmK9vxdd6.rItQCxA0sAcOu9j2/FL1JnbNNR8bH4gk3AtdO18m.Ta', '{\"attribute.attributes.index\":true,\"attribute.attributes.create\":true,\"attribute.attributes.edit\":true,\"attribute.attributes.destroy\":true,\"blog.posts.index\":true,\"blog.posts.create\":true,\"blog.posts.edit\":true,\"blog.posts.destroy\":true,\"blog.categories.index\":true,\"blog.categories.create\":true,\"blog.categories.edit\":true,\"blog.categories.destroy\":true,\"core.sidebar.group\":true,\"currency.currencies.index\":true,\"currency.currencies.create\":true,\"currency.currencies.edit\":true,\"currency.currencies.destroy\":true,\"dashboard.index\":true,\"dashboard.update\":true,\"dashboard.reset\":true,\"media.medias.index\":true,\"media.medias.create\":true,\"media.medias.edit\":true,\"media.medias.destroy\":true,\"media.folders.index\":true,\"media.folders.create\":true,\"media.folders.edit\":true,\"media.folders.destroy\":true,\"menu.menus.index\":true,\"menu.menus.create\":true,\"menu.menus.edit\":true,\"menu.menus.destroy\":true,\"menu.menuitems.index\":true,\"menu.menuitems.create\":true,\"menu.menuitems.edit\":true,\"menu.menuitems.destroy\":true,\"page.pages.index\":true,\"page.pages.create\":true,\"page.pages.edit\":true,\"page.pages.destroy\":true,\"product.attrsets.index\":true,\"product.attrsets.create\":true,\"product.attrsets.edit\":true,\"product.attrsets.destroy\":true,\"product.products.index\":true,\"product.products.create\":true,\"product.products.edit\":true,\"product.products.destroy\":true,\"product.categories.index\":true,\"product.categories.create\":true,\"product.categories.edit\":true,\"product.categories.destroy\":true,\"product.images.index\":true,\"product.images.create\":true,\"product.images.edit\":true,\"product.images.destroy\":true,\"product.skus.index\":true,\"product.skus.create\":true,\"product.skus.edit\":true,\"product.skus.destroy\":true,\"product.attrs.index\":true,\"product.attrs.create\":true,\"product.attrs.edit\":true,\"product.attrs.destroy\":true,\"sale.orders.index\":true,\"sale.orders.create\":true,\"sale.orders.edit\":true,\"sale.orders.destroy\":true,\"sale.transactions.index\":true,\"sale.transactions.create\":true,\"sale.transactions.edit\":true,\"sale.transactions.destroy\":true,\"sale.invoices.index\":true,\"sale.invoices.create\":true,\"sale.invoices.edit\":true,\"sale.invoices.destroy\":true,\"setting.settings.index\":true,\"setting.settings.edit\":true,\"tag.tags.index\":true,\"tag.tags.create\":true,\"tag.tags.edit\":true,\"tag.tags.destroy\":true,\"translation.translations.index\":true,\"translation.translations.edit\":true,\"translation.translations.import\":true,\"translation.translations.export\":true,\"user.users.index\":true,\"user.users.create\":true,\"user.users.edit\":true,\"user.users.destroy\":true,\"user.roles.index\":true,\"user.roles.create\":true,\"user.roles.edit\":true,\"user.roles.destroy\":true,\"account.api-keys.index\":true,\"account.api-keys.create\":true,\"account.api-keys.destroy\":true,\"workshop.sidebar.group\":true,\"workshop.modules.index\":true,\"workshop.modules.show\":true,\"workshop.modules.update\":true,\"workshop.modules.disable\":true,\"workshop.modules.enable\":true,\"workshop.modules.publish\":true,\"workshop.themes.index\":true,\"workshop.themes.show\":true,\"workshop.themes.publish\":true}', '2018-05-17 07:18:03', 'miya', 'yeh', '2018-02-05 10:08:17', '2018-05-17 07:18:03');
