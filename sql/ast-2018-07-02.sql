...
INSERT INTO `activations` VALUES ('7', '9', 'fkKuBLIf3QuEFYwXT6BWkWCFgftKFpdH', '1', '2018-05-21 02:53:53', '2018-05-21 02:53:53', '2018-05-21 02:53:53');
INSERT INTO `activations` VALUES ('19', '26', 'M0yav3HZQVJYNflpKACdOymU0KPuRcNh', '1', '2018-06-28 03:47:54', '2018-06-28 03:47:54', '2018-06-28 03:47:54');
...
CREATE TABLE `attribute__attribute_translations` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `attribute__attribute_translations_attribute_id_locale_unique` (`attribute_id`,`locale`) USING BTREE,
  KEY `attribute__attribute_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `attribute__attribute_translations_ibfk_1` FOREIGN KEY (`attribute_id`) REFERENCES `attribute__attributes` (`id`) ON DELETE CASCADE
...
CREATE TABLE `attribute__attribute_values` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `attribute__attribute_values_attribute_id_index` (`attribute_id`) USING BTREE,
  KEY `attribute__attribute_values_entity_type_index` (`entity_type`) USING BTREE,
  KEY `attribute__attribute_values_entity_id_index` (`entity_id`) USING BTREE
...
CREATE TABLE `attrset_attr` (
  ...
  `attribute_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `attrset_attr_attrset_id_index` (`attrset_id`) USING BTREE,
  KEY `attrset_attr_attribute_id_index` (`attribute_id`) USING BTREE
...
CREATE TABLE `blog__category_translations` (
  ...
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `blog__category_translations_category_id_locale_unique` (`category_id`,`locale`) USING BTREE,
  KEY `blog__category_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `blog__category_translations_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `blog__categories` (`id`) ON DELETE CASCADE
...
CREATE TABLE `blog__posts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `blog__posts_category_id_index` (`category_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `blog__post_translations` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `blog__post_translations_post_id_locale_unique` (`post_id`,`locale`) USING BTREE,
  KEY `blog__post_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `blog__post_translations_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `blog__posts` (`id`) ON DELETE CASCADE
...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` VALUES ('1', 'sdfsdf', '', '9', '0', '1', 'Modules\\Sale\\Entities\\OrderRefund', '0', '2018-06-19 09:06:44', null);
INSERT INTO `comments` VALUES ('2', '审批通过，退货地址为：\n浙江省台州市XXXX', '', '1', '0', '1', 'Modules\\Sale\\Entities\\OrderRefund', '0', '2018-06-19 09:19:05', null);
INSERT INTO `comments` VALUES ('3', '7天无理由退款', '2018-06-21-01-16-04-5b2afc5476c06.jpg', '9', '0', '9', 'Modules\\Sale\\Entities\\OrderRefund', '0', '2018-06-21 01:16:04', null);
INSERT INTO `comments` VALUES ('4', '审批通过', '', '1', '0', '9', 'Modules\\Sale\\Entities\\OrderRefund', '0', '2018-06-21 02:11:10', null);
INSERT INTO `comments` VALUES ('5', '颜色不对', '2018-06-21-03-37-57-5b2b1d953d910.jpg', '9', '0', '10', 'Modules\\Sale\\Entities\\OrderRefund', '0', '2018-06-21 03:37:57', null);
INSERT INTO `comments` VALUES ('6', '同意退货，退货地址是浙江省台州市XXXXX', '', '1', '0', '10', 'Modules\\Sale\\Entities\\OrderRefund', '0', '2018-06-21 03:40:04', null);
...
-- Records of currency
-- ----------------------------
INSERT INTO `currency` VALUES ('Leke', 'ALL', 'Lek');
INSERT INTO `currency` VALUES ('Dollars', 'USD', '$');
INSERT INTO `currency` VALUES ('Afghanis', 'AFN', '؋');
INSERT INTO `currency` VALUES ('Pesos', 'ARS', '$');
INSERT INTO `currency` VALUES ('Guilders', 'AWG', 'ƒ');
INSERT INTO `currency` VALUES ('Dollars', 'AUD', '$');
INSERT INTO `currency` VALUES ('New Manats', 'AZN', 'ман');
INSERT INTO `currency` VALUES ('Dollars', 'BSD', '$');
INSERT INTO `currency` VALUES ('Dollars', 'BBD', '$');
INSERT INTO `currency` VALUES ('Rubles', 'BYR', 'p.');
INSERT INTO `currency` VALUES ('Euro', 'EUR', '€');
INSERT INTO `currency` VALUES ('Dollars', 'BZD', 'BZ$');
INSERT INTO `currency` VALUES ('Dollars', 'BMD', '$');
INSERT INTO `currency` VALUES ('Bolivianos', 'BOB', '$b');
INSERT INTO `currency` VALUES ('Convertible Marka', 'BAM', 'KM');
INSERT INTO `currency` VALUES ('Pula', 'BWP', 'P');
INSERT INTO `currency` VALUES ('Leva', 'BGN', 'лв');
INSERT INTO `currency` VALUES ('Reais', 'BRL', 'R$');
INSERT INTO `currency` VALUES ('Pounds', 'GBP', '£');
INSERT INTO `currency` VALUES ('Dollars', 'BND', '$');
INSERT INTO `currency` VALUES ('Riels', 'KHR', '៛');
INSERT INTO `currency` VALUES ('Dollars', 'CAD', '$');
INSERT INTO `currency` VALUES ('Dollars', 'KYD', '$');
INSERT INTO `currency` VALUES ('Pesos', 'CLP', '$');
INSERT INTO `currency` VALUES ('Yuan Renminbi', 'CNY', '¥');
INSERT INTO `currency` VALUES ('Pesos', 'COP', '$');
INSERT INTO `currency` VALUES ('Colón', 'CRC', '₡');
INSERT INTO `currency` VALUES ('Kuna', 'HRK', 'kn');
INSERT INTO `currency` VALUES ('Pesos', 'CUP', '₱');
INSERT INTO `currency` VALUES ('Koruny', 'CZK', 'Kč');
INSERT INTO `currency` VALUES ('Kroner', 'DKK', 'kr');
INSERT INTO `currency` VALUES ('Pesos', 'DOP ', 'RD$');
INSERT INTO `currency` VALUES ('Dollars', 'XCD', '$');
INSERT INTO `currency` VALUES ('Pounds', 'EGP', '£');
INSERT INTO `currency` VALUES ('Colones', 'SVC', '$');
INSERT INTO `currency` VALUES ('Pounds', 'FKP', '£');
INSERT INTO `currency` VALUES ('Dollars', 'FJD', '$');
INSERT INTO `currency` VALUES ('Cedis', 'GHC', '¢');
INSERT INTO `currency` VALUES ('Pounds', 'GIP', '£');
INSERT INTO `currency` VALUES ('Quetzales', 'GTQ', 'Q');
INSERT INTO `currency` VALUES ('Pounds', 'GGP', '£');
INSERT INTO `currency` VALUES ('Dollars', 'GYD', '$');
INSERT INTO `currency` VALUES ('Lempiras', 'HNL', 'L');
INSERT INTO `currency` VALUES ('Dollars', 'HKD', '$');
INSERT INTO `currency` VALUES ('Forint', 'HUF', 'Ft');
INSERT INTO `currency` VALUES ('Kronur', 'ISK', 'kr');
INSERT INTO `currency` VALUES ('Rupees', 'INR', 'Rp');
INSERT INTO `currency` VALUES ('Rupiahs', 'IDR', 'Rp');
INSERT INTO `currency` VALUES ('Rials', 'IRR', '﷼');
INSERT INTO `currency` VALUES ('Pounds', 'IMP', '£');
INSERT INTO `currency` VALUES ('New Shekels', 'ILS', '₪');
INSERT INTO `currency` VALUES ('Dollars', 'JMD', 'J$');
INSERT INTO `currency` VALUES ('Yen', 'JPY', '¥');
INSERT INTO `currency` VALUES ('Pounds', 'JEP', '£');
INSERT INTO `currency` VALUES ('Tenge', 'KZT', 'лв');
INSERT INTO `currency` VALUES ('Won', 'KPW', '₩');
INSERT INTO `currency` VALUES ('Won', 'KRW', '₩');
INSERT INTO `currency` VALUES ('Soms', 'KGS', 'лв');
INSERT INTO `currency` VALUES ('Kips', 'LAK', '₭');
INSERT INTO `currency` VALUES ('Lati', 'LVL', 'Ls');
INSERT INTO `currency` VALUES ('Pounds', 'LBP', '£');
INSERT INTO `currency` VALUES ('Dollars', 'LRD', '$');
INSERT INTO `currency` VALUES ('Switzerland Francs', 'CHF', 'CHF');
INSERT INTO `currency` VALUES ('Litai', 'LTL', 'Lt');
INSERT INTO `currency` VALUES ('Denars', 'MKD', 'ден');
INSERT INTO `currency` VALUES ('Ringgits', 'MYR', 'RM');
INSERT INTO `currency` VALUES ('Rupees', 'MUR', '₨');
INSERT INTO `currency` VALUES ('Pesos', 'MXN', '$');
INSERT INTO `currency` VALUES ('Tugriks', 'MNT', '₮');
INSERT INTO `currency` VALUES ('Meticais', 'MZN', 'MT');
INSERT INTO `currency` VALUES ('Dollars', 'NAD', '$');
INSERT INTO `currency` VALUES ('Rupees', 'NPR', '₨');
INSERT INTO `currency` VALUES ('Guilders', 'ANG', 'ƒ');
INSERT INTO `currency` VALUES ('Dollars', 'NZD', '$');
INSERT INTO `currency` VALUES ('Cordobas', 'NIO', 'C$');
INSERT INTO `currency` VALUES ('Nairas', 'NGN', '₦');
INSERT INTO `currency` VALUES ('Krone', 'NOK', 'kr');
INSERT INTO `currency` VALUES ('Rials', 'OMR', '﷼');
INSERT INTO `currency` VALUES ('Rupees', 'PKR', '₨');
INSERT INTO `currency` VALUES ('Balboa', 'PAB', 'B/.');
INSERT INTO `currency` VALUES ('Guarani', 'PYG', 'Gs');
INSERT INTO `currency` VALUES ('Nuevos Soles', 'PEN', 'S/.');
INSERT INTO `currency` VALUES ('Pesos', 'PHP', 'Php');
INSERT INTO `currency` VALUES ('Zlotych', 'PLN', 'zł');
INSERT INTO `currency` VALUES ('Rials', 'QAR', '﷼');
INSERT INTO `currency` VALUES ('New Lei', 'RON', 'lei');
INSERT INTO `currency` VALUES ('Rubles', 'RUB', 'руб');
INSERT INTO `currency` VALUES ('Pounds', 'SHP', '£');
INSERT INTO `currency` VALUES ('Riyals', 'SAR', '﷼');
INSERT INTO `currency` VALUES ('Dinars', 'RSD', 'Дин.');
INSERT INTO `currency` VALUES ('Rupees', 'SCR', '₨');
INSERT INTO `currency` VALUES ('Dollars', 'SGD', '$');
INSERT INTO `currency` VALUES ('Dollars', 'SBD', '$');
INSERT INTO `currency` VALUES ('Shillings', 'SOS', 'S');
INSERT INTO `currency` VALUES ('Rand', 'ZAR', 'R');
INSERT INTO `currency` VALUES ('Rupees', 'LKR', '₨');
INSERT INTO `currency` VALUES ('Kronor', 'SEK', 'kr');
INSERT INTO `currency` VALUES ('Dollars', 'SRD', '$');
INSERT INTO `currency` VALUES ('Pounds', 'SYP', '£');
INSERT INTO `currency` VALUES ('New Dollars', 'TWD', 'NT$');
INSERT INTO `currency` VALUES ('Baht', 'THB', '฿');
INSERT INTO `currency` VALUES ('Dollars', 'TTD', 'TT$');
INSERT INTO `currency` VALUES ('Lira', 'TRY', 'TL');
INSERT INTO `currency` VALUES ('Liras', 'TRL', '£');
INSERT INTO `currency` VALUES ('Dollars', 'TVD', '$');
INSERT INTO `currency` VALUES ('Hryvnia', 'UAH', '₴');
INSERT INTO `currency` VALUES ('Pesos', 'UYU', '$U');
INSERT INTO `currency` VALUES ('Sums', 'UZS', 'лв');
INSERT INTO `currency` VALUES ('Bolivares Fuertes', 'VEF', 'Bs');
INSERT INTO `currency` VALUES ('Dong', 'VND', '₫');
INSERT INTO `currency` VALUES ('Rials', 'YER', '﷼');
INSERT INTO `currency` VALUES ('Zimbabwe Dollars', 'ZWD', 'Z$');
...
-- ----------------------------
INSERT INTO `currency_code` VALUES ('1', 'AED', '阿联酋迪拉姆', 'United Arab Emirates Dirham', null, '4');
INSERT INTO `currency_code` VALUES ('2', 'AFN', '阿富汗尼', 'Afghan Afghani', '؋', '71');
INSERT INTO `currency_code` VALUES ('3', 'ALL', '阿尔巴尼列克', 'Albania Lek', 'Le', '108');
INSERT INTO `currency_code` VALUES ('4', 'AMD', '亚美尼亚德拉姆', 'Armenia Dram', null, '483');
INSERT INTO `currency_code` VALUES ('5', 'ANG', '荷兰盾', 'Dutch Guilder', 'ƒ', null);
INSERT INTO `currency_code` VALUES ('6', 'AOA', '安哥拉宽扎', 'Angola Kwanza', null, '233');
INSERT INTO `currency_code` VALUES ('7', 'ARS', '阿根廷比索', 'Argentina Peso', '$', '24');
INSERT INTO `currency_code` VALUES ('8', 'AUD', '澳元', 'Australia Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('9', 'AWG', '阿鲁巴弗罗林', 'Aruba Florin', 'ƒ', '2');
INSERT INTO `currency_code` VALUES ('10', 'AZN', '阿塞拜疆马纳特', 'Azerbaijan Manat', 'ма', '2');
INSERT INTO `currency_code` VALUES ('11', 'BAM', '波黑可兑换马克', 'Bosnia Convertible Mark', 'KM', '2');
INSERT INTO `currency_code` VALUES ('12', 'BBD', '巴巴多斯元', 'Barbados Dollar', '$', '2');
INSERT INTO `currency_code` VALUES ('13', 'BDT', '孟加拉国塔卡', 'Bangladesh Taka', null, '84');
INSERT INTO `currency_code` VALUES ('14', 'BGN', '保加利亚列弗', 'Bulgaria Lev', 'лв', '2');
INSERT INTO `currency_code` VALUES ('15', 'BHD', '巴林第纳尔', 'Bahrain Dinar', null, '0');
INSERT INTO `currency_code` VALUES ('16', 'BIF', '布隆迪法郎', 'Burundi Franc', null, '1751');
INSERT INTO `currency_code` VALUES ('17', 'BMD', '百慕大元', 'Bermudian Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('18', 'BND', '文莱元', 'Brunei Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('19', 'BOB', '玻利维亚诺', 'Bolivian Boliviano', '$b', '7');
INSERT INTO `currency_code` VALUES ('20', 'BRL', '巴西雷亚尔', 'Brazilian Real', 'R$', '4');
INSERT INTO `currency_code` VALUES ('21', 'BSD', '巴哈马元', 'Bahamian Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('22', 'BTN', '不丹努扎姆', 'Bhutanese Ngultrum', null, '68');
INSERT INTO `currency_code` VALUES ('23', 'BWP', '博茨瓦纳普拉', 'Botswana Pula ', 'P', '10');
INSERT INTO `currency_code` VALUES ('24', 'BYR', '白俄罗斯卢布', 'Belarusian Ruble', 'p.', '20020');
INSERT INTO `currency_code` VALUES ('25', 'BZD', '伯利兹元', 'Belize Dollar', 'BZ', '2');
INSERT INTO `currency_code` VALUES ('26', 'CAD', '加元', 'Canadian Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('27', 'CDF', '刚果法郎', 'Congolese Franc', null, '1566');
INSERT INTO `currency_code` VALUES ('28', 'CHF', '瑞士法郎', 'Swiss Franc', 'CH', '1');
INSERT INTO `currency_code` VALUES ('29', 'CLF', '智利比索(基金)', 'Chilean Unidad de Fomento', null, null);
INSERT INTO `currency_code` VALUES ('30', 'CLP', '智利比索', 'Chilean Peso', '$', '632');
INSERT INTO `currency_code` VALUES ('31', 'CNH', '中国离岸人民币', 'Chinese Offshore Renminbi', null, null);
INSERT INTO `currency_code` VALUES ('32', 'CNY', '人民币', 'Chinese Yuan', '¥', '6');
INSERT INTO `currency_code` VALUES ('33', 'COP', '哥伦比亚比索', 'Colombia Peso ', '$', '2903');
INSERT INTO `currency_code` VALUES ('34', 'CRC', '哥斯达黎加科朗', 'Costa Rica Colon', '₡', '562');
INSERT INTO `currency_code` VALUES ('35', 'CUP', '古巴比索', 'Cuban Peso', '₱', '1');
INSERT INTO `currency_code` VALUES ('36', 'CVE', '佛得角埃斯库多', 'Cape Verde Escudo', null, '93');
INSERT INTO `currency_code` VALUES ('37', 'CYP', '塞普路斯镑', 'Cyprus Pound', null, null);
INSERT INTO `currency_code` VALUES ('38', 'CZK', '捷克克朗', 'Czech Republic Koruna', 'Kč', '22');
INSERT INTO `currency_code` VALUES ('39', 'DEM', '德国马克', 'Deutsche Mark', null, '2');
INSERT INTO `currency_code` VALUES ('40', 'DJF', '吉布提法郎', 'Djiboutian Franc', null, '177');
INSERT INTO `currency_code` VALUES ('41', 'DKK', '丹麦克朗', 'Danish Krone', 'kr', '6');
INSERT INTO `currency_code` VALUES ('42', 'DOP', '多米尼加比索', 'Dominican Peso', 'RD', '50');
INSERT INTO `currency_code` VALUES ('43', 'DZD', '阿尔及利亚第纳尔', 'Algerian Dinar ', null, '116');
INSERT INTO `currency_code` VALUES ('44', 'ECS', '厄瓜多尔苏克雷', 'Ecuadorian Sucre', null, null);
INSERT INTO `currency_code` VALUES ('45', 'EGP', '埃及镑', 'Egyptian Pound', '£', '18');
INSERT INTO `currency_code` VALUES ('46', 'ERN', '厄立特里亚纳克法', 'Eritrean Nakfa ', null, '15');
INSERT INTO `currency_code` VALUES ('47', 'ETB', '埃塞俄比亚比尔', 'Ethiopian Birr', null, '27');
INSERT INTO `currency_code` VALUES ('48', 'EUR', '欧元', 'Euro', '€', '1');
INSERT INTO `currency_code` VALUES ('49', 'FJD', '斐济元', 'Fiji Dollar', '$', '2');
INSERT INTO `currency_code` VALUES ('50', 'FKP', '福克兰群岛镑', 'Falkland Islands Pound', '£', '1');
INSERT INTO `currency_code` VALUES ('51', 'FRF', '法国法郎', 'French Franc', null, '6');
INSERT INTO `currency_code` VALUES ('52', 'GBP', '英镑', 'British Pound', '£', '1');
INSERT INTO `currency_code` VALUES ('53', 'GEL', '格鲁吉亚拉里', 'Georgian Lari', null, '2');
INSERT INTO `currency_code` VALUES ('54', 'GHS', '加纳塞地', 'Ghanaian Cedi', null, null);
INSERT INTO `currency_code` VALUES ('55', 'GIP', '直布罗陀镑', 'Gibraltar Pound', '£', '1');
INSERT INTO `currency_code` VALUES ('56', 'GMD', '冈比亚达拉西', 'Gambian Dalasi', null, '47');
INSERT INTO `currency_code` VALUES ('57', 'GNF', '几内亚法郎', 'Guinean Franc', null, '9000');
INSERT INTO `currency_code` VALUES ('58', 'GTQ', '危地马拉格查尔', 'Guatemalan Quetzal', 'Q', '7');
INSERT INTO `currency_code` VALUES ('59', 'GYD', '圭亚那元', 'Guyanese Dollar', '$', '207');
INSERT INTO `currency_code` VALUES ('60', 'HKD', '港币', 'Hong Kong Dollar', '$', '8');
INSERT INTO `currency_code` VALUES ('61', 'HNL', '洪都拉斯伦皮拉', 'Honduran Lempira', 'L', '24');
INSERT INTO `currency_code` VALUES ('62', 'HRK', '克罗地亚库纳', 'Croatian Kuna', 'kn', '6');
INSERT INTO `currency_code` VALUES ('63', 'HTG', '海地古德', 'Haitian Gourde', null, '63');
INSERT INTO `currency_code` VALUES ('64', 'HUF', '匈牙利福林', 'Hungarian Forint', 'Ft', '269');
INSERT INTO `currency_code` VALUES ('65', 'IDR', '印度尼西亚卢比', 'Indonesian Rupiah', 'Rp', '14150');
INSERT INTO `currency_code` VALUES ('66', 'IEP', '爱尔兰镑', 'Irish Pound', null, '1');
INSERT INTO `currency_code` VALUES ('67', 'ILS', '以色列新谢克尔', 'Israeli New Shekel', '₪', '4');
INSERT INTO `currency_code` VALUES ('68', 'INR', '印度卢比', 'Indian Rupee', 'Rp', '68');
INSERT INTO `currency_code` VALUES ('69', 'IQD', '伊拉克第纳尔', 'Iraqi Dinar', null, '1184');
INSERT INTO `currency_code` VALUES ('70', 'IRR', '伊朗里亚尔', 'Iranian Rial', '﷼', '42000');
INSERT INTO `currency_code` VALUES ('71', 'ISK', '冰岛克郎', 'Icelandic Krona', 'kr', '104');
INSERT INTO `currency_code` VALUES ('72', 'ITL', '意大利里拉', 'Italian Lira', null, '1638');
INSERT INTO `currency_code` VALUES ('73', 'JMD', '牙买加元', 'Jamaican Dollar', 'J$', '125');
INSERT INTO `currency_code` VALUES ('74', 'JOD', '约旦第纳尔', 'Jordanian Dinar', null, '1');
INSERT INTO `currency_code` VALUES ('75', 'JPY', '日元', 'Japanese Yen', '¥', '111');
INSERT INTO `currency_code` VALUES ('76', 'KES', '肯尼亚先令', 'Kenyan Shilling', null, '100');
INSERT INTO `currency_code` VALUES ('77', 'KGS', '吉尔吉斯斯坦索姆', 'Kyrgyzstani Som', 'лв', '68');
INSERT INTO `currency_code` VALUES ('78', 'KHR', '柬埔寨瑞尔', 'Cambodian Riel', '៛', '4050');
INSERT INTO `currency_code` VALUES ('79', 'KMF', '科摩罗法郎', 'Comorian franc', null, '416');
INSERT INTO `currency_code` VALUES ('80', 'KPW', '朝鲜元', 'North Korean Won', '₩', '900');
INSERT INTO `currency_code` VALUES ('81', 'KRW', '韩元', 'South Korean Won', '₩', '1079');
INSERT INTO `currency_code` VALUES ('82', 'KWD', '科威特第纳尔', 'Kuwaiti Dinar', null, '0');
INSERT INTO `currency_code` VALUES ('83', 'KYD', '开曼群岛元', 'Cayman Islands Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('84', 'KZT', '哈萨克斯坦坚戈', 'Kazakstani Tenge', 'лв', '328');
INSERT INTO `currency_code` VALUES ('85', 'LAK', '老挝基普', 'Lao kip', '₭', '8314');
INSERT INTO `currency_code` VALUES ('86', 'LBP', '黎巴嫩镑', 'Lebanese Pound', '£', '1505');
INSERT INTO `currency_code` VALUES ('87', 'LKR', '斯里兰卡卢比', 'Sri Lankan Rupee', '₨', '158');
INSERT INTO `currency_code` VALUES ('88', 'LRD', '利比里亚元', 'Liberian dollar', '$', '134');
INSERT INTO `currency_code` VALUES ('89', 'LSL', '莱索托洛蒂', 'Lesotho Loti', null, '13');
INSERT INTO `currency_code` VALUES ('90', 'LTL', '立陶宛立特', 'Lithuanian Litas', 'Lt', '3');
INSERT INTO `currency_code` VALUES ('91', 'LVL', '拉脱维亚拉特', 'Latvian Lats', 'Ls', '1');
INSERT INTO `currency_code` VALUES ('92', 'LYD', '利比亚第纳尔', 'Libyan Dinar', null, '1');
INSERT INTO `currency_code` VALUES ('93', 'MAD', '摩洛哥迪拉姆', 'Moroccan Dirham', null, '9');
INSERT INTO `currency_code` VALUES ('94', 'MDL', '摩尔多瓦列伊', 'Moldovan Leu', null, '17');
INSERT INTO `currency_code` VALUES ('95', 'MGA', '马达加斯加阿里亚里', 'Malagasy Ariary', null, '3210');
INSERT INTO `currency_code` VALUES ('96', 'MKD', '马其顿代纳尔', 'Macedonian Denar', 'де', '52');
INSERT INTO `currency_code` VALUES ('97', 'MMK', '缅甸元', 'Myanmar Kyat', null, '1349');
INSERT INTO `currency_code` VALUES ('98', 'MNT', '蒙古图格里克', 'Mongolian Tugrik', '₮', '2400');
INSERT INTO `currency_code` VALUES ('99', 'MOP', '澳门元', 'Macau Pataca', null, '8');
INSERT INTO `currency_code` VALUES ('100', 'MRO', '毛里塔尼亚乌吉亚', 'Mauritania Ouguiya', null, '354');
INSERT INTO `currency_code` VALUES ('101', 'MUR', '毛里求斯卢比', 'Mauritian Rupee', '₨', '34');
INSERT INTO `currency_code` VALUES ('102', 'MVR', '马尔代夫拉菲亚', 'Maldives Rufiyaa', null, '16');
INSERT INTO `currency_code` VALUES ('103', 'MWK', '马拉维克瓦查', 'Malawian Kwacha', null, '717');
INSERT INTO `currency_code` VALUES ('104', 'MXN', '墨西哥比索', 'Mexican Peso', '$', '20');
INSERT INTO `currency_code` VALUES ('105', 'MXV', '墨西哥(资金)', 'Mexican Unidad De Inversion', null, null);
INSERT INTO `currency_code` VALUES ('106', 'MYR', '林吉特', 'Malaysian Ringgit', 'RM', '4');
INSERT INTO `currency_code` VALUES ('107', 'MZN', '莫桑比克新梅蒂卡尔', 'New Mozambican Metical', 'MT', '60');
INSERT INTO `currency_code` VALUES ('108', 'NAD', '纳米比亚元', 'Namibian Dollar', '$', '13');
INSERT INTO `currency_code` VALUES ('109', 'NGN', '尼日利亚奈拉', 'Nigerian Naira', '₦', '358');
INSERT INTO `currency_code` VALUES ('110', 'NIO', '尼加拉瓜新科多巴', 'Nicaraguan Cordoba Oro', 'C$', '31');
INSERT INTO `currency_code` VALUES ('111', 'NOK', '挪威克朗', 'Norwegian Krone', 'kr', '8');
INSERT INTO `currency_code` VALUES ('112', 'NPR', '尼泊尔卢比', 'Nepalese Rupee', '₨', '108');
INSERT INTO `currency_code` VALUES ('113', 'NZD', '新西兰元', 'New Zealand Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('114', 'OMR', '阿曼里亚尔', 'Omani Rial', '﷼', '0');
INSERT INTO `currency_code` VALUES ('115', 'PAB', '巴拿马巴波亚', 'Panamanian Balboa', 'B/', '1');
INSERT INTO `currency_code` VALUES ('116', 'PEN', '秘鲁新索尔', 'Peruvian Nuevo Sol', 'S/', '3');
INSERT INTO `currency_code` VALUES ('117', 'PGK', '巴布亚新几内亚基那', 'Papua New Guinea Kina', null, '3');
INSERT INTO `currency_code` VALUES ('118', 'PHP', '菲律宾比索', 'Philippine Peso', 'Ph', '52');
INSERT INTO `currency_code` VALUES ('119', 'PKR', '巴基斯坦卢比', 'Pakistan Rupee', '₨', '116');
INSERT INTO `currency_code` VALUES ('120', 'PLN', '波兰兹罗提', 'Polish Zloty', 'zł', '4');
INSERT INTO `currency_code` VALUES ('121', 'PYG', '巴拉圭瓜拉尼', 'Paraguayan Guarani', 'Gs', '5607');
INSERT INTO `currency_code` VALUES ('122', 'QAR', '卡塔尔里亚尔', 'Qatari Riyal', '﷼', '4');
INSERT INTO `currency_code` VALUES ('123', 'RON', '罗马尼亚列伊', 'Romanian Leu', 'le', '4');
INSERT INTO `currency_code` VALUES ('124', 'RSD', '塞尔维亚第纳尔', 'Serbian Dinar', 'Ди', '100');
INSERT INTO `currency_code` VALUES ('125', 'RUB', '俄罗斯卢布', 'Russian Ruble', 'ру', '62');
INSERT INTO `currency_code` VALUES ('126', 'RWF', '卢旺达法郎', 'Rwandan Franc', null, '846');
INSERT INTO `currency_code` VALUES ('127', 'SAR', '沙特里亚尔', 'Saudi Arabian Riyal', '﷼', '4');
INSERT INTO `currency_code` VALUES ('128', 'SBD', '所罗门群岛元', 'Solomon Islands Dollar', '$', '8');
INSERT INTO `currency_code` VALUES ('129', 'SCR', '塞舌尔卢比', 'Seychelles Rupee', '₨', '13');
INSERT INTO `currency_code` VALUES ('130', 'SDG', '苏丹磅', 'Sudanese Pound', null, '18');
INSERT INTO `currency_code` VALUES ('131', 'SEK', '瑞典克朗', 'Swedish Krona', 'kr', '9');
INSERT INTO `currency_code` VALUES ('132', 'SGD', '新加坡元', 'Singapore Dollar', '$', '1');
INSERT INTO `currency_code` VALUES ('133', 'SHP', '圣赫勒拿镑', 'Saint Helena Pound', '£', '1');
INSERT INTO `currency_code` VALUES ('134', 'SIT', '斯洛文尼亚托拉尔', 'Slovenian Tolar', null, null);
INSERT INTO `currency_code` VALUES ('135', 'SLL', '塞拉利昂利昂', 'Sierra Leonean Leone', null, '7800');
INSERT INTO `currency_code` VALUES ('136', 'SOS', '索马里先令', 'Somali Shilling', 'S', '563');
INSERT INTO `currency_code` VALUES ('137', 'SRD', '苏里南元', 'Suriname Dollar', '$', '7');
INSERT INTO `currency_code` VALUES ('138', 'STD', '圣多美多布拉', 'Sao Tome Dobra', null, '20773');
INSERT INTO `currency_code` VALUES ('139', 'SVC', '萨尔瓦多科朗', 'Salvadoran Colon', '$', '9');
INSERT INTO `currency_code` VALUES ('140', 'SYP', '叙利亚镑', 'Syrian Pound', '£', '515');
INSERT INTO `currency_code` VALUES ('141', 'SZL', '斯威士兰里兰吉尼', 'Swazi Lilangeni', null, '13');
INSERT INTO `currency_code` VALUES ('142', 'THB', '泰铢', 'Thai Baht', '฿', '32');
INSERT INTO `currency_code` VALUES ('143', 'TJS', '塔吉克斯坦索莫尼', 'Tajikistan Somoni', null, '9');
INSERT INTO `currency_code` VALUES ('144', 'TMT', '土库曼斯坦马纳特', 'Turkmenistan Manat', null, '3');
INSERT INTO `currency_code` VALUES ('145', 'TND', '突尼斯第纳尔', 'Tunisian Dinar', null, '3');
INSERT INTO `currency_code` VALUES ('146', 'TOP', '汤加潘加', 'Tongan Pa\'Anga', null, '2');
INSERT INTO `currency_code` VALUES ('147', 'TRY', '土耳其里拉', 'Turkish Lira', 'TL', '4');
INSERT INTO `currency_code` VALUES ('148', 'TTD', '特立尼达多巴哥元', 'Trinidad and Tobago Dollar', 'TT', '7');
INSERT INTO `currency_code` VALUES ('149', 'TWD', '新台币', 'New Taiwan Dollar', 'NT', '30');
INSERT INTO `currency_code` VALUES ('150', 'TZS', '坦桑尼亚先令', 'Tanzanian Shilling', null, '2275');
INSERT INTO `currency_code` VALUES ('151', 'UAH', '乌克兰格里夫纳', 'Ukrainian Hryvnia', '₴', '26');
INSERT INTO `currency_code` VALUES ('152', 'UGX', '乌干达先令', 'Ugandan Shilling', null, '3713');
INSERT INTO `currency_code` VALUES ('153', 'USD', '美元', 'United States Dollar', '$', null);
INSERT INTO `currency_code` VALUES ('154', 'UYU', '乌拉圭比索', 'Uruguayan Peso', '$U', '31');
INSERT INTO `currency_code` VALUES ('155', 'UZS', '乌兹别克斯坦苏姆', 'Uzbekistani Som', 'лв', '8000');
INSERT INTO `currency_code` VALUES ('156', 'VEF', '委内瑞拉玻利瓦尔', 'Venezuelan Bolivar Fuerte', 'Bs', '69825');
INSERT INTO `currency_code` VALUES ('157', 'VND', '越南盾', 'Viet Nam Dong', '₫', '22784');
INSERT INTO `currency_code` VALUES ('158', 'VUV', '瓦努阿图瓦图', 'Vanuatu Vatu', null, '110');
INSERT INTO `currency_code` VALUES ('159', 'WST', '萨摩亚塔拉', 'Samoa Tala', null, '3');
INSERT INTO `currency_code` VALUES ('160', 'XAF', '中非法郎', 'Central African CFA Franc', null, '556');
INSERT INTO `currency_code` VALUES ('161', 'XAG', '银价盎司', 'Ounces of Silver', null, null);
INSERT INTO `currency_code` VALUES ('162', 'XAU', '金价盎司', 'Ounces of Gold', null, null);
INSERT INTO `currency_code` VALUES ('163', 'XCD', '东加勒比元', 'East Caribbean Dollar', '$', '3');
INSERT INTO `currency_code` VALUES ('164', 'XCP', '铜价盎司', 'Ounces of Copper', null, null);
INSERT INTO `currency_code` VALUES ('165', 'XDR', 'IMF特别提款权', 'IMF Special Drawing Rights', null, null);
INSERT INTO `currency_code` VALUES ('166', 'XOF', '西非法郎', 'West African CFA', null, '556');
INSERT INTO `currency_code` VALUES ('167', 'XPD', '钯价盎司', 'Ounces of Palladium', null, null);
INSERT INTO `currency_code` VALUES ('168', 'XPF', '太平洋法郎', 'French Pacific Franc', null, '100');
INSERT INTO `currency_code` VALUES ('169', 'XPT', '珀价盎司', 'Ounces of Platinum', null, null);
INSERT INTO `currency_code` VALUES ('170', 'YER', '也门里亚尔', 'Yemeni Rial', '﷼', '250');
INSERT INTO `currency_code` VALUES ('171', 'ZAR', '南非兰特', 'South African Rand', 'R', '13');
INSERT INTO `currency_code` VALUES ('172', 'ZMW', '赞比亚克瓦查', 'Zambian Kwacha', null, '10');
INSERT INTO `currency_code` VALUES ('173', 'ZWL', '津巴布韦元', 'Zimbabwean Dollar', null, null);

-- ----------------------------
-- Table structure for currency__currencies_rate
-- ----------------------------
DROP TABLE IF EXISTS `currency__currencies_rate`;
CREATE TABLE `currency__currencies_rate` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `currency_from` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_to` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
-- Records of currency__currencies_rate
-- ----------------------------
INSERT INTO `currency__currencies_rate` VALUES ('1', 'USD', 'CNY', '6.37', '¥', '2018-05-18 09:34:47', '2018-05-18 10:08:11');
INSERT INTO `currency__currencies_rate` VALUES ('2', 'USD', 'EUR', '0.85', '€', '2018-05-18 09:34:47', '2018-05-18 09:34:47');
INSERT INTO `currency__currencies_rate` VALUES ('3', 'USD', 'GBP', '0.74', '£', '2018-05-18 09:34:47', '2018-05-18 09:34:47');
INSERT INTO `currency__currencies_rate` VALUES ('4', 'USD', 'USD', '1.00', '$', '2018-05-18 09:34:47', '2018-05-18 09:34:47');
...
INSERT INTO `customer_address` VALUES ('2', 'Melody', 'Li', 'bb@bb.com', '13472740668', '7', 'China', '249', 'Hebei', '3058', 'Baoding', '200120', '1', '0', '上海市浦东新区上浦路36弄42号602', '2018-05-22 10:34:20', '2018-05-22 10:34:20');
...
-- ----------------------------
INSERT INTO `followables` VALUES ('9', '0', 'Modules\\User\\Entities\\Sentinel\\User', 'downvote', null, '2018-06-19 06:56:07', null);
INSERT INTO `followables` VALUES ('9', '2', 'Modules\\Sale\\Entities\\OrderReview', 'upvote', null, '2018-06-19 07:49:51', null);
INSERT INTO `followables` VALUES ('9', '1', 'Modules\\Sale\\Entities\\OrderReview', 'downvote', null, '2018-06-19 07:50:04', null);
INSERT INTO `followables` VALUES ('9', '3', 'Modules\\Sale\\Entities\\ProductReviewReply', 'upvote', null, '2018-06-19 07:56:01', null);
INSERT INTO `followables` VALUES ('9', '1', 'Modules\\Sale\\Entities\\ProductReviewReply', 'downvote', null, '2018-06-19 07:56:53', null);
INSERT INTO `followables` VALUES ('9', '2', 'Modules\\Sale\\Entities\\ProductReviewReply', 'downvote', null, '2018-06-19 07:56:59', null);
INSERT INTO `followables` VALUES ('9', '7', 'Modules\\Product\\Entities\\Product', 'favorite', null, '2018-06-19 08:46:10', null);
INSERT INTO `followables` VALUES ('1', '10', 'Modules\\Sale\\Entities\\ProductReviewReply', 'upvote', null, '2018-06-26 08:10:58', null);
...
INSERT INTO `media__files` VALUES ('3', '0', '2018-06-12-06-44-17-5b1f6bc1abcc9.jpg', '/assets/media/2018-06-12-06-44-17-5b1f6bc1abcc9.jpg', 'jpg', 'image/jpeg', '159699', '0', '2018-06-12 06:44:17', '2018-06-12 06:44:17');
INSERT INTO `media__files` VALUES ('4', '0', '2018-06-12-06-44-19-5b1f6bc31ade0.jpg', '/assets/media/2018-06-12-06-44-19-5b1f6bc31ade0.jpg', 'jpg', 'image/jpeg', '201497', '0', '2018-06-12 06:44:19', '2018-06-12 06:44:19');
INSERT INTO `media__files` VALUES ('5', '0', '2018-06-12-06-44-19-5b1f6bc3c561b.jpg', '/assets/media/2018-06-12-06-44-19-5b1f6bc3c561b.jpg', 'jpg', 'image/jpeg', '192049', '0', '2018-06-12 06:44:19', '2018-06-12 06:44:19');
INSERT INTO `media__files` VALUES ('6', '0', '2018-06-12-07-43-51-5b1f79b79ca38.jpg', '/assets/media/2018-06-12-07-43-51-5b1f79b79ca38.jpg', 'jpg', 'image/jpeg', '161738', '0', '2018-06-12 07:43:51', '2018-06-12 07:43:51');
INSERT INTO `media__files` VALUES ('7', '0', '2018-06-12-07-43-52-5b1f79b85edde.jpg', '/assets/media/2018-06-12-07-43-52-5b1f79b85edde.jpg', 'jpg', 'image/jpeg', '159265', '0', '2018-06-12 07:43:52', '2018-06-12 07:43:52');
INSERT INTO `media__files` VALUES ('8', '0', '2018-06-12-07-43-53-5b1f79b926e24.jpg', '/assets/media/2018-06-12-07-43-53-5b1f79b926e24.jpg', 'jpg', 'image/jpeg', '149063', '0', '2018-06-12 07:43:53', '2018-06-12 07:43:53');
INSERT INTO `media__files` VALUES ('9', '0', '2018-06-12-07-43-53-5b1f79b9d02cf.jpg', '/assets/media/2018-06-12-07-43-53-5b1f79b9d02cf.jpg', 'jpg', 'image/jpeg', '84871', '0', '2018-06-12 07:43:53', '2018-06-12 07:43:53');
INSERT INTO `media__files` VALUES ('10', '0', '2018-06-12-07-43-54-5b1f79ba7d279.jpg', '/assets/media/2018-06-12-07-43-54-5b1f79ba7d279.jpg', 'jpg', 'image/jpeg', '82364', '0', '2018-06-12 07:43:54', '2018-06-12 07:43:54');
...
INSERT INTO `media__imageables` VALUES ('15', '7', '6', 'Modules\\Product\\Entities\\Product', 'gallery', '0', '2018-06-12 07:44:30', '2018-06-12 07:53:04', null);
INSERT INTO `media__imageables` VALUES ('16', '6', '6', 'Modules\\Product\\Entities\\Product', 'gallery', '1', '2018-06-12 07:44:30', '2018-06-12 07:53:04', null);
INSERT INTO `media__imageables` VALUES ('17', '8', '6', 'Modules\\Product\\Entities\\Product', 'gallery', '2', '2018-06-12 07:44:30', '2018-06-12 07:53:04', null);
INSERT INTO `media__imageables` VALUES ('18', '9', '6', 'Modules\\Product\\Entities\\Product', 'gallery', '3', '2018-06-12 07:44:30', '2018-06-12 07:53:04', null);
INSERT INTO `media__imageables` VALUES ('19', '10', '6', 'Modules\\Product\\Entities\\Product', 'gallery', '4', '2018-06-12 07:44:30', '2018-06-12 07:53:04', null);
INSERT INTO `media__imageables` VALUES ('20', '4', '7', 'Modules\\Product\\Entities\\Product', 'gallery', '0', '2018-06-12 07:51:54', '2018-06-12 07:52:38', null);
INSERT INTO `media__imageables` VALUES ('21', '5', '7', 'Modules\\Product\\Entities\\Product', 'gallery', '1', '2018-06-12 07:51:54', '2018-06-12 07:52:38', null);
INSERT INTO `media__imageables` VALUES ('22', '3', '7', 'Modules\\Product\\Entities\\Product', 'gallery', '2', '2018-06-12 07:51:54', '2018-06-12 07:52:38', null);
...
INSERT INTO `migrations` VALUES ('81', '2018_05_17_014721864276_create_currency_currencies_table', '14');
INSERT INTO `migrations` VALUES ('133', '2018_06_06_094150342011_create_mpay_comment_translations_table', '15');
INSERT INTO `migrations` VALUES ('140', '2018_05_10_012153965075_create_mpay_paypalipns_table', '16');
INSERT INTO `migrations` VALUES ('141', '2018_05_10_020321181227_create_mpay_orders_table', '16');
INSERT INTO `migrations` VALUES ('142', '2018_06_25_025200597110_create_notification_notifications_table', '17');
INSERT INTO `migrations` VALUES ('143', '2018_06_25_025201855844_create_notification_messages_table', '17');

-- ----------------------------
-- Table structure for mpay__comments
-- ----------------------------
DROP TABLE IF EXISTS `mpay__comments`;
CREATE TABLE `mpay__comments` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of mpay__comments
-- ----------------------------

-- ----------------------------
-- Table structure for mpay__comment_translations
-- ----------------------------
DROP TABLE IF EXISTS `mpay__comment_translations`;
CREATE TABLE `mpay__comment_translations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `comment_id` int(10) unsigned NOT NULL,
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `mpay__comment_translations_comment_id_locale_unique` (`comment_id`,`locale`),
  KEY `mpay__comment_translations_locale_index` (`locale`),
  CONSTRAINT `mpay__comment_translations_comment_id_foreign` FOREIGN KEY (`comment_id`) REFERENCES `mpay__comments` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of mpay__comment_translations
-- ----------------------------
...
CREATE TABLE `notifications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `notification__notifications_notifiable_id_notifiable_type_index` (`notifiable_id`,`notifiable_type`)
) ENGINE=InnoDB AUTO_INCREMENT=4294967295 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of notifications
-- ----------------------------
INSERT INTO `notifications` VALUES ('4294967295', 'Modules\\Sale\\Notifications\\CommentReplyNotification', '9', 'Modules\\User\\Entities\\Sentinel\\User', '{\"from_user_id\":1,\"content\":\"Hello! Thank you so much for uploading your photo with us. I\'m gratified to know that you are satisfied with this blue shirt. If you like it, you can share your good experience with your friends, that\'d be really kind of you! Again, we wish to really thank you for your kindness!\",\"dialog\":\"1-9\"}', '2018-06-26 08:02:14', '2018-06-26 08:01:36', '2018-06-26 08:02:14');

-- ----------------------------
-- Table structure for notification__messages
-- ----------------------------
DROP TABLE IF EXISTS `notification__messages`;
CREATE TABLE `notification__messages` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of notification__messages
-- ----------------------------
...
CREATE TABLE `oauth` (
  ...
  UNIQUE KEY `oauth id` (`social_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of oauth
-- ----------------------------
INSERT INTO `oauth` VALUES ('9A4DD8F7309B40647C14673A224F5731', '9CD1464283020E832F33711EF856BBD0', '26', 'listen。。', 'qq');
...
CREATE TABLE `orders` (
  ...
  `is_ordered_with_supplier` tinyint(1) NOT NULL DEFAULT '0',
  `amount` decimal(18,2) NOT NULL,
  `amount_current_currency` decimal(18,2) NOT NULL,
  ...
  `consign_time` timestamp NOT NULL,
  `end_time` timestamp NOT NULL,
  `order_with_supplier_at` timestamp NOT NULL,
  `buyer_message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `buyer_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `buyer_remark` tinyint(1) NOT NULL,
  `order_locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('2018061505211', '7PG14016217570256', '11', '1', '460.00', '391.00', 'EUR', '9', 'paypal', '', '', '0000-00-00 00:00:00', '2018-06-16 10:08:17', '0000-00-00 00:00:00', '2018-06-15 07:22:06', '', '', '0', '', '', '1', '1', '2018-06-15 07:18:57', '2018-06-15 07:45:59', null);
INSERT INTO `orders` VALUES ('2018062046075', '17R30375RU750603L', '12', '1', '358.00', '304.30', 'EUR', '9', 'paypal', '', '', '2018-06-20 09:12:10', '2018-06-20 09:17:56', '0000-00-00 00:00:00', '2018-06-20 09:15:14', '', '', '0', '', '', '1', '1', '2018-06-20 09:12:10', '2018-06-20 09:17:56', null);
INSERT INTO `orders` VALUES ('2018062087490', '27J79589XS4873631', '16', '0', '256.00', '217.60', 'EUR', '9', 'paypal', '', '', '2018-06-20 02:50:25', '2018-06-20 02:50:25', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '1', '0', '2018-06-20 02:50:23', '2018-06-20 08:14:56', null);
INSERT INTO `orders` VALUES ('2018062153805', '7DA84189VY900362K', '12', '1', '230.00', '195.50', 'EUR', '9', 'paypal', '', '', '2018-06-21 03:11:14', '2018-06-21 03:20:01', '0000-00-00 00:00:00', '2018-06-21 03:19:38', '', '', '0', '', '', '1', '1', '2018-06-21 03:11:14', '2018-06-21 03:20:01', null);
INSERT INTO `orders` VALUES ('2018062802920', '', '1', '0', '0.00', '0.00', 'EUR', '9', 'paypal', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:06:38', '2018-06-28 09:06:38', null);
INSERT INTO `orders` VALUES ('2018062805722', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:47:07', '2018-06-28 09:47:07', null);
INSERT INTO `orders` VALUES ('2018062807828', '2MT00451T3180945A', '3', '0', '230.00', '195.50', 'EUR', '9', 'paypal', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:07:11', '2018-06-28 09:10:23', null);
INSERT INTO `orders` VALUES ('2018062816084', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:47:38', '2018-06-28 09:47:38', null);
INSERT INTO `orders` VALUES ('2018062818904', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:17:52', '2018-06-28 09:17:52', null);
INSERT INTO `orders` VALUES ('2018062827198', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:12:00', '2018-06-28 09:12:00', null);
INSERT INTO `orders` VALUES ('2018062840222', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:46:09', '2018-06-28 09:46:09', null);
INSERT INTO `orders` VALUES ('2018062867133', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'paypal', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:05:13', '2018-06-28 09:05:13', null);
INSERT INTO `orders` VALUES ('2018062874544', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:36:06', '2018-06-28 09:36:06', null);
INSERT INTO `orders` VALUES ('2018062889835', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:34:59', '2018-06-28 09:34:59', null);
INSERT INTO `orders` VALUES ('2018062889944', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:40:09', '2018-06-28 09:40:09', null);
INSERT INTO `orders` VALUES ('2018062896686', '', '1', '0', '230.00', '195.50', 'EUR', '9', 'alipay', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '0', '', '', '0', '0', '2018-06-28 09:44:55', '2018-06-28 09:44:55', null);
...
-- ----------------------------
INSERT INTO `order_address` VALUES ('1', '2018061505211', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-15 07:18:57', '2018-06-15 07:18:57');
INSERT INTO `order_address` VALUES ('2', '2018062087490', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-20 02:50:23', '2018-06-20 02:50:23');
INSERT INTO `order_address` VALUES ('3', '2018062046075', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-20 09:12:10', '2018-06-20 09:12:10');
INSERT INTO `order_address` VALUES ('4', '2018062153805', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-21 03:11:14', '2018-06-21 03:11:14');
INSERT INTO `order_address` VALUES ('5', '2018062867133', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:05:13', '2018-06-28 09:05:13');
INSERT INTO `order_address` VALUES ('6', '2018062802920', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:06:38', '2018-06-28 09:06:38');
INSERT INTO `order_address` VALUES ('7', '2018062807828', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:07:11', '2018-06-28 09:07:11');
INSERT INTO `order_address` VALUES ('8', '2018062827198', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:12:00', '2018-06-28 09:12:00');
INSERT INTO `order_address` VALUES ('9', '2018062818904', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:17:52', '2018-06-28 09:17:52');
INSERT INTO `order_address` VALUES ('10', '2018062889835', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:34:59', '2018-06-28 09:34:59');
INSERT INTO `order_address` VALUES ('11', '2018062874544', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:36:06', '2018-06-28 09:36:06');
INSERT INTO `order_address` VALUES ('12', '2018062889944', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:40:09', '2018-06-28 09:40:09');
INSERT INTO `order_address` VALUES ('13', '2018062896686', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:44:55', '2018-06-28 09:44:55');
INSERT INTO `order_address` VALUES ('14', '2018062840222', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:46:09', '2018-06-28 09:46:09');
INSERT INTO `order_address` VALUES ('15', '2018062805722', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:47:07', '2018-06-28 09:47:07');
INSERT INTO `order_address` VALUES ('16', '2018062816084', 'JUAN YE', '123', '', 'Albania', 'shanghai', 'Shanghai', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '200120', '2018-06-28 09:47:38', '2018-06-28 09:47:38');

-- ----------------------------
-- Table structure for order_alipay_ipn_records
-- ----------------------------
DROP TABLE IF EXISTS `order_alipay_ipn_records`;
CREATE TABLE `order_alipay_ipn_records` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
  `trade_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
-- Records of order_alipay_ipn_records
-- ----------------------------
...
CREATE TABLE `order_item` (
  ...
  `unit_price_current_currency` decimal(18,2) NOT NULL,
  `subtotal` decimal(8,2) NOT NULL,
  `subtotal_current_currency` decimal(18,2) NOT NULL,
...
-- ----------------------------
INSERT INTO `order_item` VALUES ('1', '2018061505211', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-15 07:18:57', '2018-06-15 07:18:57');
INSERT INTO `order_item` VALUES ('2', '2018061505211', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u7ea2\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":2}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-15 07:18:57', '2018-06-15 07:18:57');
INSERT INTO `order_item` VALUES ('3', '2018062087490', '7', '1', '黑色休闲长裙', '{\"sku_options\":{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u76ae\\u9769\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-black-dress\",\"userId\":9,\"index\":1}', '128.00', '108.80', '128.00', '108.80', 'http://localhost:8000/assets/media/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg', '/product/casual-black-dress', '2018-06-20 02:50:23', '2018-06-20 02:50:23');
INSERT INTO `order_item` VALUES ('4', '2018062087490', '7', '1', '黑色休闲长裙', '{\"sku_options\":{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"l\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u76ae\\u9769\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u7ea2\\u8272\",\"\\u5c3a\\u7801\":\"\\u5927\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-black-dress\",\"userId\":9,\"index\":2}', '128.00', '108.80', '128.00', '108.80', 'http://localhost:8000/assets/media/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg', '/product/casual-black-dress', '2018-06-20 02:50:23', '2018-06-20 02:50:23');
INSERT INTO `order_item` VALUES ('5', '2018062046075', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-20 09:12:10', '2018-06-20 09:12:10');
INSERT INTO `order_item` VALUES ('6', '2018062046075', '7', '1', '黑色休闲长裙', '{\"sku_options\":{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u76ae\\u9769\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-black-dress\",\"userId\":9,\"index\":2}', '128.00', '108.80', '128.00', '108.80', 'http://localhost:8000/assets/media/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg', '/product/casual-black-dress', '2018-06-20 09:12:10', '2018-06-20 09:12:10');
INSERT INTO `order_item` VALUES ('7', '2018062153805', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-21 03:11:14', '2018-06-21 03:11:14');
INSERT INTO `order_item` VALUES ('8', '2018062867133', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:05:13', '2018-06-28 09:05:13');
INSERT INTO `order_item` VALUES ('9', '2018062807828', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:07:11', '2018-06-28 09:07:11');
INSERT INTO `order_item` VALUES ('10', '2018062827198', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:12:00', '2018-06-28 09:12:00');
INSERT INTO `order_item` VALUES ('11', '2018062818904', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:17:52', '2018-06-28 09:17:52');
INSERT INTO `order_item` VALUES ('12', '2018062889835', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:34:59', '2018-06-28 09:34:59');
INSERT INTO `order_item` VALUES ('13', '2018062874544', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:36:06', '2018-06-28 09:36:06');
INSERT INTO `order_item` VALUES ('14', '2018062889944', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:40:09', '2018-06-28 09:40:09');
INSERT INTO `order_item` VALUES ('15', '2018062896686', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:44:55', '2018-06-28 09:44:55');
INSERT INTO `order_item` VALUES ('16', '2018062840222', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:46:09', '2018-06-28 09:46:09');
INSERT INTO `order_item` VALUES ('17', '2018062805722', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:47:07', '2018-06-28 09:47:07');
INSERT INTO `order_item` VALUES ('18', '2018062816084', '6', '1', '休闲套装女', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '230.00', '195.50', '230.00', '195.50', 'http://localhost:8000/assets/media/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg', '/product/casual-women-suits', '2018-06-28 09:47:38', '2018-06-28 09:47:38');
...
-- ----------------------------
INSERT INTO `order_operation` VALUES ('1', '2018061505211', '1', '待付款', '2018-06-15 07:18:57', '2018-06-15 07:18:57');
INSERT INTO `order_operation` VALUES ('2', '2018061505211', '6', '正在出库', '2018-06-15 07:22:02', '2018-06-15 07:22:02');
INSERT INTO `order_operation` VALUES ('3', '2018061505211', '6', '正在出库', '2018-06-15 07:22:06', '2018-06-15 07:22:06');
INSERT INTO `order_operation` VALUES ('4', '2018061505211', '7', '已发货', '2018-06-15 07:22:09', '2018-06-15 07:22:09');
INSERT INTO `order_operation` VALUES ('5', '2018061505211', '9', '已签收', '2018-06-15 07:45:20', '2018-06-15 07:45:20');
INSERT INTO `order_operation` VALUES ('6', '2018061505211', '9', '已签收', '2018-06-15 07:45:59', '2018-06-15 07:45:59');
INSERT INTO `order_operation` VALUES ('7', '2018061505211', '10', '商品退库申请,等待卖家确认中', '2018-06-19 09:06:44', '2018-06-19 09:06:44');
INSERT INTO `order_operation` VALUES ('8', '2018061505211', '11', '商家确认退库申请', '2018-06-19 09:19:05', '2018-06-19 09:19:05');
INSERT INTO `order_operation` VALUES ('9', '2018062087490', '1', '待付款', '2018-06-20 02:50:23', '2018-06-20 02:50:23');
INSERT INTO `order_operation` VALUES ('11', '2018062087490', '15', '退款申请', '2018-06-20 07:23:39', '2018-06-20 07:23:39');
INSERT INTO `order_operation` VALUES ('12', '2018062087490', '15', '退款申请', '2018-06-20 07:24:52', '2018-06-20 07:24:52');
INSERT INTO `order_operation` VALUES ('13', '2018062087490', '15', '退款申请', '2018-06-20 07:28:08', '2018-06-20 07:28:08');
INSERT INTO `order_operation` VALUES ('14', '2018062087490', '16', '退款申请审批通过', '2018-06-20 07:50:21', '2018-06-20 07:50:21');
INSERT INTO `order_operation` VALUES ('15', '2018062087490', '16', '退款申请审批通过', '2018-06-20 07:55:51', '2018-06-20 07:55:51');
INSERT INTO `order_operation` VALUES ('16', '2018062087490', '16', '退款申请审批通过', '2018-06-20 08:07:14', '2018-06-20 08:07:14');
INSERT INTO `order_operation` VALUES ('17', '2018062087490', '15', '退款申请', '2018-06-20 08:14:56', '2018-06-20 08:14:56');
INSERT INTO `order_operation` VALUES ('18', '2018062087490', '16', '退款申请审批通过', '2018-06-20 08:15:18', '2018-06-20 08:15:18');
INSERT INTO `order_operation` VALUES ('19', '2018062046075', '1', '待付款', '2018-06-20 09:12:10', '2018-06-20 09:12:10');
INSERT INTO `order_operation` VALUES ('20', '2018062046075', '6', '正在出库', '2018-06-20 09:15:14', '2018-06-20 09:15:14');
INSERT INTO `order_operation` VALUES ('21', '2018062046075', '7', '已发货', '2018-06-20 09:16:00', '2018-06-20 09:16:00');
INSERT INTO `order_operation` VALUES ('22', '2018062046075', '9', '已签收', '2018-06-20 09:17:56', '2018-06-20 09:17:56');
INSERT INTO `order_operation` VALUES ('23', '2018062046075', '10', '商品退库申请,等待卖家确认中', '2018-06-21 01:16:04', '2018-06-21 01:16:04');
INSERT INTO `order_operation` VALUES ('24', '2018062046075', '11', '商家确认退库申请', '2018-06-21 02:11:10', '2018-06-21 02:11:10');
INSERT INTO `order_operation` VALUES ('25', '2018062046075', '12', '退库中', '2018-06-21 02:55:37', '2018-06-21 02:55:37');
INSERT INTO `order_operation` VALUES ('26', '2018062153805', '1', '待付款', '2018-06-21 03:11:14', '2018-06-21 03:11:14');
INSERT INTO `order_operation` VALUES ('27', '2018062153805', '6', '正在出库', '2018-06-21 03:19:36', '2018-06-21 03:19:36');
INSERT INTO `order_operation` VALUES ('28', '2018062153805', '6', '正在出库', '2018-06-21 03:19:38', '2018-06-21 03:19:38');
INSERT INTO `order_operation` VALUES ('29', '2018062153805', '7', '已发货', '2018-06-21 03:19:48', '2018-06-21 03:19:48');
INSERT INTO `order_operation` VALUES ('30', '2018062153805', '9', '已签收', '2018-06-21 03:20:01', '2018-06-21 03:20:01');
INSERT INTO `order_operation` VALUES ('31', '2018062153805', '10', '商品退库申请,等待卖家确认中', '2018-06-21 03:37:57', '2018-06-21 03:37:57');
INSERT INTO `order_operation` VALUES ('32', '2018062153805', '11', '商家确认退库申请', '2018-06-21 03:40:04', '2018-06-21 03:40:04');
INSERT INTO `order_operation` VALUES ('33', '2018062153805', '12', '退库中', '2018-06-21 03:52:38', '2018-06-21 03:52:38');
INSERT INTO `order_operation` VALUES ('34', '2018062867133', '1', '待付款', '2018-06-28 09:05:13', '2018-06-28 09:05:13');
INSERT INTO `order_operation` VALUES ('35', '2018062802920', '1', '待付款', '2018-06-28 09:06:38', '2018-06-28 09:06:38');
INSERT INTO `order_operation` VALUES ('36', '2018062807828', '1', '待付款', '2018-06-28 09:07:11', '2018-06-28 09:07:11');
INSERT INTO `order_operation` VALUES ('37', '2018062827198', '1', '待付款', '2018-06-28 09:12:00', '2018-06-28 09:12:00');
INSERT INTO `order_operation` VALUES ('38', '2018062818904', '1', '待付款', '2018-06-28 09:17:52', '2018-06-28 09:17:52');
INSERT INTO `order_operation` VALUES ('39', '2018062889835', '1', '待付款', '2018-06-28 09:34:59', '2018-06-28 09:34:59');
INSERT INTO `order_operation` VALUES ('40', '2018062874544', '1', '待付款', '2018-06-28 09:36:06', '2018-06-28 09:36:06');
INSERT INTO `order_operation` VALUES ('41', '2018062889944', '1', '待付款', '2018-06-28 09:40:09', '2018-06-28 09:40:09');
INSERT INTO `order_operation` VALUES ('42', '2018062896686', '1', '待付款', '2018-06-28 09:44:55', '2018-06-28 09:44:55');
INSERT INTO `order_operation` VALUES ('43', '2018062840222', '1', '待付款', '2018-06-28 09:46:09', '2018-06-28 09:46:09');
INSERT INTO `order_operation` VALUES ('44', '2018062805722', '1', '待付款', '2018-06-28 09:47:07', '2018-06-28 09:47:07');
INSERT INTO `order_operation` VALUES ('45', '2018062816084', '1', '待付款', '2018-06-28 09:47:38', '2018-06-28 09:47:38');

-- ----------------------------
-- Table structure for order_paypal_ipn_records
-- ----------------------------
DROP TABLE IF EXISTS `order_paypal_ipn_records`;
CREATE TABLE `order_paypal_ipn_records` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL,
...
-- ----------------------------
-- Records of order_paypal_ipn_records
-- ----------------------------
...
CREATE TABLE `order_refund` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payerId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_order_shipped` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_order_received` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `need_return_goods` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` decimal(8,2) NOT NULL,
  `approve_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `refund_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `item_id` int(11) DEFAULT NULL,
  `currency` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `refund_no` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `order_refund_order_id_unique` (`order_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of order_refund
-- ----------------------------
INSERT INTO `order_refund` VALUES ('1', '2018061505211', '', '1', '', '1', '391.00', '1', '1', '9', '2018-06-19 09:06:44', null, '6', null, null);
INSERT INTO `order_refund` VALUES ('4', '2018062087490', '', '0', '', '0', '108.80', '0', '1', '9', '2018-06-20 07:28:08', null, '3', 'EUR', 'RE201806204');
INSERT INTO `order_refund` VALUES ('8', '2018062087490', '', '0', '', '0', '108.80', '1', '1', '9', '2018-06-20 08:14:56', '2018-06-20 08:15:18', '4', 'EUR', 'RE201806208');
INSERT INTO `order_refund` VALUES ('9', '2018062046075', '', '1', '', '1', '194.50', '1', '', '9', '2018-06-21 01:16:04', null, '5', null, null);
INSERT INTO `order_refund` VALUES ('10', '2018062153805', '', '1', '', '1', '194.50', '1', '', '9', '2018-06-21 03:37:57', null, '7', null, null);
...
CREATE TABLE `order_return` (
  ...
  `return_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `shipping_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `pickup_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_return_order_id_unique` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of order_return
-- ----------------------------
INSERT INTO `order_return` VALUES ('1', '2018062046075', '5', '0', 'china-post', 'RM121516216CN', '1', '2018-06-21 02:55:37', null, '2018-06-22 16:24:18', null);
INSERT INTO `order_return` VALUES ('2', '2018062153805', '7', '0', 'china-post', 'RM131516216CN', '1', '2018-06-21 03:52:38', null, '2018-06-22 15:41:48', '2018-06-22 15:41:48');
...
-- ----------------------------
INSERT INTO `order_shipping` VALUES ('1', '2018061505211', 'ems', '1234', 'SHIPPING20180615922540', '2018-06-15 07:22:09', '2018-06-22 02:26:19', 'pickup');
INSERT INTO `order_shipping` VALUES ('2', '2018062046075', 'ems', '12345', 'SHIPPING20180620877913', '2018-06-20 09:16:00', '2018-06-20 09:16:00', null);
INSERT INTO `order_shipping` VALUES ('3', '2018062153805', 'china-post', 'RM131516216CN', 'SHIPPING20180621808921', '2018-06-21 03:19:48', '2018-06-21 03:19:48', null);

-- ----------------------------
-- Table structure for order_shipping_tracking
-- ----------------------------
DROP TABLE IF EXISTS `order_shipping_tracking`;
CREATE TABLE `order_shipping_tracking` (
...
-- ----------------------------
-- Records of order_shipping_tracking
-- ----------------------------
...
CREATE TABLE `order_supplier` (
  ...
  `supplier_item_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_item_slug` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_unit_price` decimal(8,2) NOT NULL,
  `supplier_subtotal` decimal(8,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=2218 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `persistences` VALUES ('1806', '1', 'MDpna7nIYzCHEq7jF3d9pPKiJ2o1ECad', '2018-05-09 08:29:43', '2018-05-09 08:29:43');
INSERT INTO `persistences` VALUES ('1807', '1', 'Nvel7qmOLSsJOawJj1T5gHE7vDqGQ8dS', '2018-05-09 08:56:54', '2018-05-09 08:56:54');
INSERT INTO `persistences` VALUES ('1808', '1', 'DcMsPnuQZVWdKj27Z1QSPiT4tkoI5B2o', '2018-05-09 09:51:49', '2018-05-09 09:51:49');
INSERT INTO `persistences` VALUES ('1809', '1', 'p7PPRM2c4Tggx0wtBwgfPRV6D12Ij6DA', '2018-05-09 10:28:09', '2018-05-09 10:28:09');
INSERT INTO `persistences` VALUES ('1810', '1', 'YPDKGiJoHqROTnDEfwOepSntjPwxzjSv', '2018-05-10 06:22:05', '2018-05-10 06:22:05');
INSERT INTO `persistences` VALUES ('1811', '1', 'qYeQNPpdjBAUi5lPShvsye72Q1sGoJwO', '2018-05-10 07:43:24', '2018-05-10 07:43:24');
INSERT INTO `persistences` VALUES ('1812', '1', '7mWOWJs1McCQyeMgXTFZmY2vZnQCtMfq', '2018-05-10 09:14:35', '2018-05-10 09:14:35');
INSERT INTO `persistences` VALUES ('1813', '1', 'N0XcZfHC03ghUovUfyiDbSjOC7Aihv1L', '2018-05-10 09:14:40', '2018-05-10 09:14:40');
INSERT INTO `persistences` VALUES ('1814', '1', 'aV6090KKpeDn26eZPafWGCpt7NdgJl55', '2018-05-11 01:10:12', '2018-05-11 01:10:12');
INSERT INTO `persistences` VALUES ('1815', '1', 'TMlOh3vT2cEniN2O2kZbctlYCbjl5YiV', '2018-05-11 03:07:29', '2018-05-11 03:07:29');
INSERT INTO `persistences` VALUES ('1816', '1', 'uBzaF7qXvZDwBp5AzqPEslub6ZE2X0OE', '2018-05-11 03:07:39', '2018-05-11 03:07:39');
INSERT INTO `persistences` VALUES ('1817', '1', 'WIDCFhdWp9tTeSrEYZLpmM2prMlx2yBj', '2018-05-11 06:22:57', '2018-05-11 06:22:57');
INSERT INTO `persistences` VALUES ('1818', '1', 'p5FpeVoQ9V6chzQuJQJmvdFuDzfy3Ppp', '2018-05-14 03:03:57', '2018-05-14 03:03:57');
INSERT INTO `persistences` VALUES ('1819', '1', 'u65k6ufxsYyzoBHah469XCBPXbjwPQZ5', '2018-05-14 07:06:31', '2018-05-14 07:06:31');
INSERT INTO `persistences` VALUES ('1820', '1', '8UvZZYhBXQJLj7NJ7bFg0hXK2xcmfSCi', '2018-05-14 07:23:30', '2018-05-14 07:23:30');
INSERT INTO `persistences` VALUES ('1821', '1', 'zacBu1gRS2ycyXmoS0UolVjksCync85q', '2018-05-15 07:22:03', '2018-05-15 07:22:03');
INSERT INTO `persistences` VALUES ('1822', '1', 'F9dB1SaEKvTqVefftikBmb43wc5x5ql0', '2018-05-15 07:33:33', '2018-05-15 07:33:33');
INSERT INTO `persistences` VALUES ('1823', '1', 'rdp8xJrvKBBjc66nTAYSfJvTFOj5p2YB', '2018-05-16 01:26:23', '2018-05-16 01:26:23');
INSERT INTO `persistences` VALUES ('1824', '1', 'LoAo3ArufMsjvfK4cKL9n1fmtCBomWME', '2018-05-16 03:12:38', '2018-05-16 03:12:38');
INSERT INTO `persistences` VALUES ('1825', '1', 'tBECP0kzDJNZmlNP37F0L2qPzz9dlI6u', '2018-05-16 03:12:38', '2018-05-16 03:12:38');
INSERT INTO `persistences` VALUES ('1826', '1', 'Odad7RO1ZoBRb3ZpgDH8g86jvXNRBwGa', '2018-05-16 06:15:25', '2018-05-16 06:15:25');
INSERT INTO `persistences` VALUES ('1827', '1', 'TgPovKKZYREBYD3gmgr92aQ28MjDwANf', '2018-05-16 07:45:51', '2018-05-16 07:45:51');
INSERT INTO `persistences` VALUES ('1828', '1', 'iJTLKmn06k3QfS3eESTzRomUIt21njN1', '2018-05-16 07:46:17', '2018-05-16 07:46:17');
INSERT INTO `persistences` VALUES ('1829', '1', 'Po5Isgn1JEP7mJLUNCJJ0kOrjjMq6cXK', '2018-05-16 07:46:45', '2018-05-16 07:46:45');
INSERT INTO `persistences` VALUES ('1830', '1', 'oQS7JZ7nWQ4r7b7b06B9zaotEWEHau1u', '2018-05-16 07:46:45', '2018-05-16 07:46:45');
INSERT INTO `persistences` VALUES ('1831', '1', 'dNaXmFC4WqLbJSO7svrlnN0W4IGbgrjS', '2018-05-16 07:46:46', '2018-05-16 07:46:46');
INSERT INTO `persistences` VALUES ('1832', '1', 'f03iTmL81jKipz9tzKtJxnz29gXwYFIz', '2018-05-16 07:46:52', '2018-05-16 07:46:52');
INSERT INTO `persistences` VALUES ('1833', '1', '82eguTSQxdgyP9hbT3M9R7PydyHhJpJ3', '2018-05-16 07:46:52', '2018-05-16 07:46:52');
INSERT INTO `persistences` VALUES ('1834', '1', 'sV8Gg27dR1KSKbzvLmSwzvD8nG0KIdhj', '2018-05-16 07:46:52', '2018-05-16 07:46:52');
INSERT INTO `persistences` VALUES ('1835', '1', 'pK1bXA2ywnPn46uSioaevnEOof4fQUzH', '2018-05-16 07:48:12', '2018-05-16 07:48:12');
INSERT INTO `persistences` VALUES ('1836', '1', 'F0ms3h06txKiYdMUGNZDEk7SdQHWg5L3', '2018-05-16 07:48:19', '2018-05-16 07:48:19');
INSERT INTO `persistences` VALUES ('1837', '1', '4aHoJnZGVZBgnOMFkEPZs8GfV6jRfdwS', '2018-05-16 08:16:00', '2018-05-16 08:16:00');
INSERT INTO `persistences` VALUES ('1838', '1', 'rqilyOvg3Hq0bHfwHZYhy0OoAgf3kfIu', '2018-05-16 08:16:14', '2018-05-16 08:16:14');
INSERT INTO `persistences` VALUES ('1839', '1', 'YmN5O6rU2mF4LZH71ri1iJ4SYC9zszrI', '2018-05-16 08:16:14', '2018-05-16 08:16:14');
INSERT INTO `persistences` VALUES ('1840', '1', 'jaA7gH9kKgePaORh1xLASOJJwCvqOqbY', '2018-05-16 08:17:00', '2018-05-16 08:17:00');
INSERT INTO `persistences` VALUES ('1841', '1', 'gW1vbKe2rT1sWK58p6GaS6UBFhUaGnpT', '2018-05-16 08:17:42', '2018-05-16 08:17:42');
INSERT INTO `persistences` VALUES ('1842', '1', 'gapI3x6FR1inVM7xtQHvEgQQKSEPZeNm', '2018-05-16 08:17:59', '2018-05-16 08:17:59');
INSERT INTO `persistences` VALUES ('1843', '1', 'VUvPOB1zcjFewN0TWNeYqWvkbwZDuxHe', '2018-05-16 08:18:20', '2018-05-16 08:18:20');
INSERT INTO `persistences` VALUES ('1844', '1', 'z8MCAfwXt8nawupcYdFLWqYsOHGM6lIu', '2018-05-16 08:18:40', '2018-05-16 08:18:40');
INSERT INTO `persistences` VALUES ('1845', '1', 'KKkWucajek3BVQRgOlkW68WmVgIaRUhr', '2018-05-16 08:18:54', '2018-05-16 08:18:54');
INSERT INTO `persistences` VALUES ('1846', '1', 'NVOj9OCd2IImFeQrNiaIuUy7g6B66dc7', '2018-05-16 08:19:09', '2018-05-16 08:19:09');
INSERT INTO `persistences` VALUES ('1847', '1', 'Yb8IsxKb8Gw1c3aQQe299fM3rX1unnzR', '2018-05-16 08:19:29', '2018-05-16 08:19:29');
INSERT INTO `persistences` VALUES ('1848', '1', 'ABMKXcaB4c3dhxFW2j1KOmyw5J0YV9Sc', '2018-05-16 08:19:40', '2018-05-16 08:19:40');
INSERT INTO `persistences` VALUES ('1849', '1', 'fsnCacrqYxFTFEbFR0dgHKk7mpWbjskj', '2018-05-17 01:43:34', '2018-05-17 01:43:34');
INSERT INTO `persistences` VALUES ('1850', '1', 'ROQDhRNrEpHlaf6bpcGfAbBD7MGxoduU', '2018-05-17 02:15:09', '2018-05-17 02:15:09');
INSERT INTO `persistences` VALUES ('1851', '1', 'FWqgl5XYaHu7ODuUMAbV5wRVlNS3zgZ6', '2018-05-17 02:15:25', '2018-05-17 02:15:25');
INSERT INTO `persistences` VALUES ('1852', '1', 'Yx8kGraaQJrrmTxGUDZpUHwLnj9fX44T', '2018-05-17 02:15:25', '2018-05-17 02:15:25');
INSERT INTO `persistences` VALUES ('1853', '1', 'qBORGMfsuH8YZQNyAMORocmwvYkSYTwG', '2018-05-17 02:15:26', '2018-05-17 02:15:26');
INSERT INTO `persistences` VALUES ('1854', '1', 'f3d2fXks1vw4X0ePwNOH9o75kwAjFbmy', '2018-05-17 02:16:05', '2018-05-17 02:16:05');
INSERT INTO `persistences` VALUES ('1855', '1', 'pf28N17qjQnsD11H4rOuKR8mVJNhyQmE', '2018-05-17 02:16:06', '2018-05-17 02:16:06');
INSERT INTO `persistences` VALUES ('1856', '1', '9OGaVdCxbCvv1tGAK7q42lhGujLUt57h', '2018-05-17 02:16:12', '2018-05-17 02:16:12');
INSERT INTO `persistences` VALUES ('1857', '1', '6JMPXa9BNTzHO2STCb0cAPS1puE2FgWZ', '2018-05-17 02:29:13', '2018-05-17 02:29:13');
INSERT INTO `persistences` VALUES ('1858', '1', 'cC2pprpuPqgS5Bz4x6p0JBiQ4IMvVFsA', '2018-05-17 02:29:15', '2018-05-17 02:29:15');
INSERT INTO `persistences` VALUES ('1859', '1', 'oKT8hvyDFzgPAR1vQtRwaMjGGBhXz2XQ', '2018-05-17 02:29:15', '2018-05-17 02:29:15');
INSERT INTO `persistences` VALUES ('1860', '1', 'VAWXGu8lrY0kb8t0tLYGJWdc9Tx8G7i0', '2018-05-17 02:29:16', '2018-05-17 02:29:16');
INSERT INTO `persistences` VALUES ('1861', '1', 'mQZkL3q1rh1IVE4mP0GXMChoogWvLHXg', '2018-05-17 02:30:17', '2018-05-17 02:30:17');
INSERT INTO `persistences` VALUES ('1862', '1', 'vqwNtfg7XHsSLoNZZJbv8gYZt6m5wCya', '2018-05-17 02:30:17', '2018-05-17 02:30:17');
INSERT INTO `persistences` VALUES ('1863', '1', 'Zsg4HLjn7kjpnckhx75iKcdVI5MZslcO', '2018-05-17 02:30:17', '2018-05-17 02:30:17');
INSERT INTO `persistences` VALUES ('1864', '1', 'dnoayTTh46eBKpbxtNw5xhBlT3RmsG15', '2018-05-17 05:55:53', '2018-05-17 05:55:53');
INSERT INTO `persistences` VALUES ('1865', '1', 'KLaOOEtsd8yjkhh9VXzv69iECNrmiJuP', '2018-05-17 07:18:03', '2018-05-17 07:18:03');
INSERT INTO `persistences` VALUES ('1866', '1', 'aViepbiYO5GhQT07dDsUzYTm9RskRd4x', '2018-05-17 08:09:20', '2018-05-17 08:09:20');
INSERT INTO `persistences` VALUES ('1867', '1', 'OmisD6TsrS8Xd84F5Nv9gViejsKDV2d0', '2018-05-17 08:09:23', '2018-05-17 08:09:23');
INSERT INTO `persistences` VALUES ('1868', '1', 'rFOTMND10dVgsKoeil5e7AU6O6xbq2Ae', '2018-05-17 08:09:23', '2018-05-17 08:09:23');
INSERT INTO `persistences` VALUES ('1869', '1', 'QaGIueOC1vPBiaDfHsZPE1iUzm9Ly0kv', '2018-05-17 08:09:24', '2018-05-17 08:09:24');
INSERT INTO `persistences` VALUES ('1870', '1', 'PkIDMHDsyj76aLzPLprcMGEXncOGgplb', '2018-05-17 08:09:30', '2018-05-17 08:09:30');
INSERT INTO `persistences` VALUES ('1871', '1', 'ZZNz7n0FBfRB6Nnmp8KWdoWO4OQSxf4c', '2018-05-17 08:09:31', '2018-05-17 08:09:31');
INSERT INTO `persistences` VALUES ('1872', '1', 'lFOAqzrIkpvDTtHjt9SrTGE6ZwdDfZJw', '2018-05-17 08:09:41', '2018-05-17 08:09:41');
INSERT INTO `persistences` VALUES ('1873', '1', 'FutmMjr3r8iXsnyACvQ4pMFNKLfy1kJR', '2018-05-18 01:03:03', '2018-05-18 01:03:03');
INSERT INTO `persistences` VALUES ('1874', '1', 'nO9iVXLCz0IZLeIzeQmd8Ds3xIJYo2iH', '2018-05-18 01:17:02', '2018-05-18 01:17:02');
INSERT INTO `persistences` VALUES ('1875', '1', '58Qjl5YiKThUElHzwPiuVg5DuWSQ5p3c', '2018-05-18 01:27:53', '2018-05-18 01:27:53');
INSERT INTO `persistences` VALUES ('1876', '1', 'imGMEBaTMFtonhPzvhhAqkPUgNbXRS1U', '2018-05-18 04:48:52', '2018-05-18 04:48:52');
INSERT INTO `persistences` VALUES ('1877', '1', '0rucOWTPnamv9IRDoRP9tYMLUdJ6qUSf', '2018-05-18 06:11:24', '2018-05-18 06:11:24');
INSERT INTO `persistences` VALUES ('1878', '1', '29NfTyFsQs7e84RvEq9OeMlqkC5ykJIU', '2018-05-18 07:41:01', '2018-05-18 07:41:01');
INSERT INTO `persistences` VALUES ('1879', '1', 'yJjNFEPwluSDibbCHufJTrOlK3Ei9zia', '2018-05-18 09:40:16', '2018-05-18 09:40:16');
INSERT INTO `persistences` VALUES ('1880', '1', 'gTr1e92RsRLL1FLrYK66FXuprJiT5eyS', '2018-05-21 00:53:54', '2018-05-21 00:53:54');
INSERT INTO `persistences` VALUES ('1882', '1', 'QC2z84KjPPtWx70MhaM4PmBNLqhvrJir', '2018-05-21 02:33:49', '2018-05-21 02:33:49');
INSERT INTO `persistences` VALUES ('1883', '1', '3r0lvg50dxjeYSTcUHLmiimyA83CSbtG', '2018-05-21 02:35:41', '2018-05-21 02:35:41');
INSERT INTO `persistences` VALUES ('1884', '1', 'IXAWlzC2ZHI8I19TxoFUP2SgHXvie4EG', '2018-05-21 02:35:51', '2018-05-21 02:35:51');
INSERT INTO `persistences` VALUES ('1885', '1', 'fukZ3zc88KiWItZHOzYw98jGnSb88PZx', '2018-05-21 02:37:28', '2018-05-21 02:37:28');
INSERT INTO `persistences` VALUES ('1886', '1', 'LI21cuDvPXPmwreNpILA6rSPybyGNNiQ', '2018-05-21 02:38:32', '2018-05-21 02:38:32');
INSERT INTO `persistences` VALUES ('1888', '1', 'RG44T0vhnvW2AFbBEgbRzOQXGFBntVju', '2018-05-21 02:50:24', '2018-05-21 02:50:24');
INSERT INTO `persistences` VALUES ('1889', '1', 'oARNVrC4AwYivuE1hzfj6AKjA5c10v0U', '2018-05-21 02:50:33', '2018-05-21 02:50:33');
INSERT INTO `persistences` VALUES ('1890', '1', '4r0zTBuVkNGU2kcFMXDxK8n72z7oXtul', '2018-05-21 02:50:33', '2018-05-21 02:50:33');
INSERT INTO `persistences` VALUES ('1891', '1', 'UMx87TDV1sAytoEybi2MVc6QTQ1xVRZK', '2018-05-21 02:50:34', '2018-05-21 02:50:34');
INSERT INTO `persistences` VALUES ('1892', '1', '1wcHTdc80s0YZYOOm0mwPNv11Ee5oLCU', '2018-05-21 02:51:02', '2018-05-21 02:51:02');
INSERT INTO `persistences` VALUES ('1893', '1', 'imQObv0Qn9aB4WcDQuISp32SkmpxJm1H', '2018-05-21 02:51:07', '2018-05-21 02:51:07');
INSERT INTO `persistences` VALUES ('1894', '1', 'Zv4vyBo4Vn9kdoAmbVua13ca13Gf21mS', '2018-05-21 02:53:49', '2018-05-21 02:53:49');
INSERT INTO `persistences` VALUES ('1895', '1', 'G049SCadQ09KSNc6gMowL3ArQk4FnpVv', '2018-05-21 02:53:49', '2018-05-21 02:53:49');
INSERT INTO `persistences` VALUES ('1896', '1', 'DhK6KlYL4hI6hlwTAQggUZbtQaMXGIrT', '2018-05-21 02:53:49', '2018-05-21 02:53:49');
INSERT INTO `persistences` VALUES ('1897', '1', 'n7MaeBd32ECzW1AoKIpI0nNjz1ajA3Jw', '2018-05-21 02:53:53', '2018-05-21 02:53:53');
INSERT INTO `persistences` VALUES ('1898', '1', '44zsDRs2bqyQtWsbhWT7LebMaAu7X8Za', '2018-05-21 02:53:53', '2018-05-21 02:53:53');
INSERT INTO `persistences` VALUES ('1899', '1', '1NmJCkIiGVGuuIX9ay5Tucijs7tIReIr', '2018-05-21 02:53:56', '2018-05-21 02:53:56');
INSERT INTO `persistences` VALUES ('1900', '1', 'muNNee0hVrZu7PPwOFmp5ZO7KnH6wonK', '2018-05-21 02:53:56', '2018-05-21 02:53:56');
INSERT INTO `persistences` VALUES ('1901', '1', '0OJACAF0LrB9jkMRXxFajKQZvhwVJ7wP', '2018-05-21 02:53:56', '2018-05-21 02:53:56');
INSERT INTO `persistences` VALUES ('1903', '1', 'qHIlEJ9haT1Yxr0SkehF1rOmsP2DvvgH', '2018-05-21 04:02:25', '2018-05-21 04:02:25');
INSERT INTO `persistences` VALUES ('1904', '1', '6ePMRS4LQsNkByUYmUBqy917JQJpFXWQ', '2018-05-21 07:32:41', '2018-05-21 07:32:41');
INSERT INTO `persistences` VALUES ('1905', '1', 'kbfdcq5uTXQuQQ3Hj67hPc6GTHj7r7Dm', '2018-05-22 01:21:21', '2018-05-22 01:21:21');
INSERT INTO `persistences` VALUES ('1906', '1', '8oghuyVbP1ZEAiAP3mnPBEKx87vlJkbV', '2018-05-23 01:37:19', '2018-05-23 01:37:19');
INSERT INTO `persistences` VALUES ('1907', '1', 'zMko2LK8DHEaZb2euSKi9gaG1GQqEuI3', '2018-05-23 03:58:02', '2018-05-23 03:58:02');
INSERT INTO `persistences` VALUES ('1908', '1', '5TCPrGhwEQ7f4UzBmwHo70OK89HrGDwE', '2018-05-23 03:58:29', '2018-05-23 03:58:29');
INSERT INTO `persistences` VALUES ('1909', '1', 'V7Q1HRFeN4InLnrxnew3UCM6b2kcoPp3', '2018-05-23 03:59:33', '2018-05-23 03:59:33');
INSERT INTO `persistences` VALUES ('1910', '1', 'zmvbCvi0yx9Q5NSSGfiLzIfh4U0mMxuN', '2018-05-23 04:00:04', '2018-05-23 04:00:04');
INSERT INTO `persistences` VALUES ('1911', '1', 'c5sEgyiSukouONjJ1qTPzilj4hRlyoZp', '2018-05-23 04:00:51', '2018-05-23 04:00:51');
INSERT INTO `persistences` VALUES ('1912', '1', 'WW2PHJ03HxOmqW7Wl0B1h4SgVBq8WfCZ', '2018-05-23 04:02:59', '2018-05-23 04:02:59');
INSERT INTO `persistences` VALUES ('1913', '1', '5A5iC3by7xvIwY9yzPD3nkz09iaDgeZd', '2018-05-23 05:20:30', '2018-05-23 05:20:30');
INSERT INTO `persistences` VALUES ('1914', '1', 'nr5A0Vfs73SUKn33yjSwz4zxtWpj5xYx', '2018-05-23 05:21:39', '2018-05-23 05:21:39');
INSERT INTO `persistences` VALUES ('1915', '1', 'ilzUsYh74T7NyzFhdAARgFJRCPsaujSa', '2018-05-23 05:21:39', '2018-05-23 05:21:39');
INSERT INTO `persistences` VALUES ('1916', '1', 'TYLWgUfrOK9NDvjSkf60ZIGqmtHqRLNa', '2018-05-23 05:22:36', '2018-05-23 05:22:36');
INSERT INTO `persistences` VALUES ('1917', '1', 'PSDV2ZGD5u73G6ghpdazHSiGSfqnm6B8', '2018-05-23 05:22:36', '2018-05-23 05:22:36');
INSERT INTO `persistences` VALUES ('1918', '1', 'iDUEmsHufxoGvt2wipsXX4K95uXxzXXs', '2018-05-23 05:29:00', '2018-05-23 05:29:00');
INSERT INTO `persistences` VALUES ('1919', '1', 'stfC2fHQH25vSwSgyPSmNIOD8t0a0qYp', '2018-05-23 05:29:01', '2018-05-23 05:29:01');
INSERT INTO `persistences` VALUES ('1920', '1', 'SV3BQD67VHyhd0K1JH53X6D9N6LLdROe', '2018-05-23 05:33:44', '2018-05-23 05:33:44');
INSERT INTO `persistences` VALUES ('1921', '1', 'YNGCi10urjy8mcOfvCkfPgslQk2nZ2cz', '2018-05-23 05:33:45', '2018-05-23 05:33:45');
INSERT INTO `persistences` VALUES ('1922', '1', '0XOn1rucUsbSoEBIJbdmsmSIuSQGy7YR', '2018-05-23 05:34:28', '2018-05-23 05:34:28');
INSERT INTO `persistences` VALUES ('1923', '1', 'FvFRCrmKdLXFLSw9B4iX8IryPVNxFIeO', '2018-05-23 05:34:29', '2018-05-23 05:34:29');
INSERT INTO `persistences` VALUES ('1924', '1', 'byHFCdpXQMCv907lw4PMnpaI3EWpwas3', '2018-05-23 05:35:02', '2018-05-23 05:35:02');
INSERT INTO `persistences` VALUES ('1925', '1', 'rSF4WQKuQg0VWTyWELvVwlplQJ69pLLy', '2018-05-23 05:35:03', '2018-05-23 05:35:03');
INSERT INTO `persistences` VALUES ('1926', '1', 'Tp6qBwgcNlmPgbiDihz6wW4pTNixmWqS', '2018-05-23 05:56:52', '2018-05-23 05:56:52');
INSERT INTO `persistences` VALUES ('1927', '1', 'TZXNRGyS9YLIdNl3H1sqmdUH2s7AhYBz', '2018-05-23 05:56:57', '2018-05-23 05:56:57');
INSERT INTO `persistences` VALUES ('1928', '1', 'cMDV9pPE0xAF9WclH2NEVdsYZUyTOo8F', '2018-05-23 05:56:57', '2018-05-23 05:56:57');
INSERT INTO `persistences` VALUES ('1929', '1', 'Z1AA48ZQMEk9xTSZjzX7EsvpmcsNbOqs', '2018-05-23 05:56:58', '2018-05-23 05:56:58');
INSERT INTO `persistences` VALUES ('1930', '1', 'nE0d0Dj5gAzfJGX3QZEEi59tHcRbM5H9', '2018-05-23 05:57:02', '2018-05-23 05:57:02');
INSERT INTO `persistences` VALUES ('1931', '1', 'Gw4ebWjezfNibZRLaYh4sQAqr0DavmTf', '2018-05-23 05:57:03', '2018-05-23 05:57:03');
INSERT INTO `persistences` VALUES ('1932', '1', 'PQid11Jn4nnew72RU6JM1Dpk8d85BX4L', '2018-05-23 05:57:11', '2018-05-23 05:57:11');
INSERT INTO `persistences` VALUES ('1933', '1', 'oWfY22Xw2GqGs2zLBqNPx6VNvRxLUs6w', '2018-05-23 05:58:20', '2018-05-23 05:58:20');
INSERT INTO `persistences` VALUES ('1934', '1', '2XecseemE2mKI8bfF4vG02WJTpZ8PmKg', '2018-05-23 05:58:33', '2018-05-23 05:58:33');
INSERT INTO `persistences` VALUES ('1935', '1', 'YFxhnRHIxjPMgXVyHTo4I5VavfY5CafA', '2018-05-23 06:01:10', '2018-05-23 06:01:10');
INSERT INTO `persistences` VALUES ('1936', '1', '0lu7qG1BrsySuIeOfKhpWUEjszfUgqee', '2018-05-23 06:01:19', '2018-05-23 06:01:19');
INSERT INTO `persistences` VALUES ('1937', '1', 'nMr3RzoFu26LWVZzc51mmesO3Mr5rbdF', '2018-05-23 06:01:22', '2018-05-23 06:01:22');
INSERT INTO `persistences` VALUES ('1938', '1', 'VxxuQHvNHWfFUmSPfDKTZDXK4vXe4OI7', '2018-05-23 06:01:23', '2018-05-23 06:01:23');
INSERT INTO `persistences` VALUES ('1939', '1', '5nvmJWVRXSHhoUkvZPHW7wNtomzdfjbc', '2018-05-23 06:01:23', '2018-05-23 06:01:23');
INSERT INTO `persistences` VALUES ('1940', '1', 'pTV1Mi1ck3MEyF2YBiLd7BW9xfzRHGHc', '2018-05-23 06:01:52', '2018-05-23 06:01:52');
INSERT INTO `persistences` VALUES ('1941', '1', 'CTpxD9GBOxPuIPhYmJFlISRdfcYJRHi2', '2018-05-23 06:01:52', '2018-05-23 06:01:52');
INSERT INTO `persistences` VALUES ('1942', '1', 'nO0AcITB86BWnCEBPhs3dioUHp1w7o2A', '2018-05-23 06:01:59', '2018-05-23 06:01:59');
INSERT INTO `persistences` VALUES ('1943', '1', 'fEi8CAm981fVXgI5p0lVdy1O3bLBDyL4', '2018-05-24 00:53:09', '2018-05-24 00:53:09');
INSERT INTO `persistences` VALUES ('1944', '1', '1hcMzWi7B27babIE8HNBm3QREG5d1Fur', '2018-05-24 06:00:50', '2018-05-24 06:00:50');
INSERT INTO `persistences` VALUES ('1945', '1', 'zLJJqV5nqaRqnvLABCHEQLtc2qmmokuQ', '2018-05-25 01:21:50', '2018-05-25 01:21:50');
INSERT INTO `persistences` VALUES ('1946', '1', 'G5DHtKdm2VZcSTUXBda7pA4VdvqZFHU8', '2018-05-25 01:29:15', '2018-05-25 01:29:15');
INSERT INTO `persistences` VALUES ('1947', '1', 'XTlAcpXJV71rA6LGeKx7XR8ENdUkKmY4', '2018-05-30 06:37:39', '2018-05-30 06:37:39');
INSERT INTO `persistences` VALUES ('1948', '1', '6YKjbWhaajBKEKAo00SvrsPAAyPjCZtJ', '2018-05-30 06:52:44', '2018-05-30 06:52:44');
INSERT INTO `persistences` VALUES ('1949', '1', 'm34EtOfKQEoPIVULxDOJaTh4LuiiXvyb', '2018-05-31 03:51:52', '2018-05-31 03:51:52');
INSERT INTO `persistences` VALUES ('1950', '1', 'tKUXMGMLuchvsQHKmCgfe3QCXyul3TSy', '2018-06-01 02:36:48', '2018-06-01 02:36:48');
INSERT INTO `persistences` VALUES ('1951', '1', 'Q6n1VjJxuFyaXRs6rhrEb4pWp5Zc3zps', '2018-06-01 06:05:58', '2018-06-01 06:05:58');
INSERT INTO `persistences` VALUES ('1952', '1', '5Kwde47cZZzgY0opvN8Fb0mNRuN6daCl', '2018-06-04 07:09:27', '2018-06-04 07:09:27');
INSERT INTO `persistences` VALUES ('1953', '1', 'CFEq3HsInnVc3ZpDM7s0DhyHD1pudr5n', '2018-06-04 09:08:28', '2018-06-04 09:08:28');
INSERT INTO `persistences` VALUES ('1954', '1', 'xCHTbXKXZyu73pRrc1bnaNlGzGdG9SBy', '2018-06-05 01:46:50', '2018-06-05 01:46:50');
INSERT INTO `persistences` VALUES ('1955', '1', 'iRLoH8bSsKp9fvUiZ2I9FSNNgHNPC2kt', '2018-06-07 03:13:39', '2018-06-07 03:13:39');
INSERT INTO `persistences` VALUES ('1956', '1', 'Zbgfm8LjSVk2tkMw4jGLoVPi7EM1AIKl', '2018-06-07 07:49:27', '2018-06-07 07:49:27');
INSERT INTO `persistences` VALUES ('1957', '1', 'HhXAo5GoVn52WRCpwElWfZUiVZxkc9VI', '2018-06-08 01:00:11', '2018-06-08 01:00:11');
INSERT INTO `persistences` VALUES ('1958', '1', 'nvUVvP3gIvFvRX85619UeewDQsUQpcbd', '2018-06-08 01:43:55', '2018-06-08 01:43:55');
INSERT INTO `persistences` VALUES ('1959', '1', 'A7ENwTifU1M9du5LjkYZC3zp2n85VBUi', '2018-06-08 01:44:03', '2018-06-08 01:44:03');
INSERT INTO `persistences` VALUES ('1960', '1', '8eBErJBXtD31wZmU8vH0wo1J2By3kJNS', '2018-06-08 01:44:45', '2018-06-08 01:44:45');
INSERT INTO `persistences` VALUES ('1961', '1', 'oUFHizqmy2CTMOk2yk3YWyNY8LqKnb1B', '2018-06-08 01:45:15', '2018-06-08 01:45:15');
INSERT INTO `persistences` VALUES ('1962', '1', 'mn7MLxKSGwXnNhNh1TWkG3ZH6dvPep1Y', '2018-06-08 01:45:46', '2018-06-08 01:45:46');
INSERT INTO `persistences` VALUES ('1963', '1', '8ooqXuJUbX5E3IQSWIgdt1hk6GNpbiYM', '2018-06-08 01:45:57', '2018-06-08 01:45:57');
INSERT INTO `persistences` VALUES ('1964', '1', 'x5m0R66xClisRQpAESx3uzWoRgbY4Qro', '2018-06-08 01:46:10', '2018-06-08 01:46:10');
INSERT INTO `persistences` VALUES ('1965', '1', 'IPEEjIdOA5EwA1XDiFxWvB8RKd80CEBq', '2018-06-08 01:46:10', '2018-06-08 01:46:10');
INSERT INTO `persistences` VALUES ('1967', '1', 'SrNKBaactwhRpto6Dmk3PeVdxs3kDJ9V', '2018-06-11 03:09:23', '2018-06-11 03:09:23');
INSERT INTO `persistences` VALUES ('1968', '1', '2zMLYIPSMZsiQK2PShTWWLyBKq3EO8dM', '2018-06-12 06:35:05', '2018-06-12 06:35:05');
INSERT INTO `persistences` VALUES ('1969', '1', 'tVfhaUgP00jB7hOZqnQzWT88t51DbcXw', '2018-06-12 06:36:20', '2018-06-12 06:36:20');
INSERT INTO `persistences` VALUES ('1970', '1', 'prwd3QNBqz7GI3fhTMFYf2EzmU2WvJCi', '2018-06-12 06:36:21', '2018-06-12 06:36:21');
INSERT INTO `persistences` VALUES ('1971', '1', 'YrSqvRdnbjvVcdZMPUaU95lXwU4FQ2AP', '2018-06-12 06:38:57', '2018-06-12 06:38:57');
INSERT INTO `persistences` VALUES ('1972', '1', 'V7ZYswyle7ABdQq6i1Cq2Lz98z4wJOOq', '2018-06-12 06:40:32', '2018-06-12 06:40:32');
INSERT INTO `persistences` VALUES ('1973', '1', 'YGiL8QpRbFDSYcroIoZOQbPgIJWIkz7w', '2018-06-12 06:42:08', '2018-06-12 06:42:08');
INSERT INTO `persistences` VALUES ('1974', '1', 'Pm6wpuJyFHy6A9jQH6GmoaoQcYjkLD3k', '2018-06-12 06:43:19', '2018-06-12 06:43:19');
INSERT INTO `persistences` VALUES ('1975', '1', 'eRgwzaci6hLVMPMcqB8vs25D6FsTv24A', '2018-06-12 06:44:17', '2018-06-12 06:44:17');
INSERT INTO `persistences` VALUES ('1976', '1', 'mNXFiMwyIzJ5kFM6yxOTmyiNS7lmGZum', '2018-06-12 06:44:19', '2018-06-12 06:44:19');
INSERT INTO `persistences` VALUES ('1977', '1', 'kO4qv07gFF3alzjJGybixOeBzlFX7SRu', '2018-06-12 06:44:19', '2018-06-12 06:44:19');
INSERT INTO `persistences` VALUES ('1978', '1', 'bAd2ZiO68cuAithRXhI8hLDcnEBI0bSw', '2018-06-12 06:50:17', '2018-06-12 06:50:17');
INSERT INTO `persistences` VALUES ('1979', '1', '6NTT8da4sXNgJG5rTIco2oHoX2x8ijvW', '2018-06-12 06:50:22', '2018-06-12 06:50:22');
INSERT INTO `persistences` VALUES ('1980', '1', 'tLaDszRCkLHVflkkbwdnW2JW4ODcQlEV', '2018-06-12 06:52:52', '2018-06-12 06:52:52');
INSERT INTO `persistences` VALUES ('1981', '1', 'NiP2UHx49TXBmFDjvtN05OnoHVtujnu6', '2018-06-12 06:52:53', '2018-06-12 06:52:53');
INSERT INTO `persistences` VALUES ('1982', '1', 'DjJ65K77u2UXQSoxFApXy2juUjWfPVTL', '2018-06-12 06:53:31', '2018-06-12 06:53:31');
INSERT INTO `persistences` VALUES ('1983', '1', 'mtWRyu534k9ye6TdbYjkZIoYggboZENT', '2018-06-12 06:53:32', '2018-06-12 06:53:32');
INSERT INTO `persistences` VALUES ('1984', '1', 'qUflFDWNR8LmFVqssQFY8gim5GtqUKfH', '2018-06-12 07:00:14', '2018-06-12 07:00:14');
INSERT INTO `persistences` VALUES ('1985', '1', 'Wbtwdzdjwhi7DgG0a8XppOU0SHmzm8CZ', '2018-06-12 07:00:34', '2018-06-12 07:00:34');
INSERT INTO `persistences` VALUES ('1986', '1', 'TvDsdPoHB6SCLHBi8oPSrJqlJsKpExh0', '2018-06-12 07:00:35', '2018-06-12 07:00:35');
INSERT INTO `persistences` VALUES ('1987', '1', 'DvoH48Ab4Eup7T0tz5V8KqhVeIQ8Woj5', '2018-06-12 07:00:44', '2018-06-12 07:00:44');
INSERT INTO `persistences` VALUES ('1988', '1', 'kz9EvWe9dlSLq8nIXkdCScnJ3hD2yaNh', '2018-06-12 07:00:45', '2018-06-12 07:00:45');
INSERT INTO `persistences` VALUES ('1989', '1', 'BNESNAznODnyp1sRUdhzJTWawcz2hn74', '2018-06-12 07:02:21', '2018-06-12 07:02:21');
INSERT INTO `persistences` VALUES ('1990', '1', '2EYSN3sPV9JcqdSTA9kNEF4NcWBjcmeA', '2018-06-12 07:02:21', '2018-06-12 07:02:21');
INSERT INTO `persistences` VALUES ('1991', '1', '6AXTjpl8f8Xo8iQruluIne0T3oBbnFke', '2018-06-12 07:14:42', '2018-06-12 07:14:42');
INSERT INTO `persistences` VALUES ('1992', '1', 'Ue3hhPyoSFzncOLR9YENak5rq2I8DuC3', '2018-06-12 07:14:42', '2018-06-12 07:14:42');
INSERT INTO `persistences` VALUES ('1993', '1', '5ZC08nJeAcIQ00J2V16lCiMLqobWkmfB', '2018-06-12 07:18:39', '2018-06-12 07:18:39');
INSERT INTO `persistences` VALUES ('1994', '1', 'FJufGrSlDdHIcv9DbucouDBkHbJH1r31', '2018-06-12 07:18:39', '2018-06-12 07:18:39');
INSERT INTO `persistences` VALUES ('1995', '1', 's744fXVkmYHRZdlb1zYSvJmQTkPDbiym', '2018-06-12 07:19:24', '2018-06-12 07:19:24');
INSERT INTO `persistences` VALUES ('1996', '1', '4GNbKL9WpUMWv9C90srm42nwzVFPyEDl', '2018-06-12 07:19:24', '2018-06-12 07:19:24');
INSERT INTO `persistences` VALUES ('1997', '1', 'vJsu1nONqD5Idythr0qnEhQzGMw3sDzm', '2018-06-12 07:23:01', '2018-06-12 07:23:01');
INSERT INTO `persistences` VALUES ('1998', '1', '9wNPBMhLx4t9qJS9XTFjbXBk6M7NLn4r', '2018-06-12 07:23:01', '2018-06-12 07:23:01');
INSERT INTO `persistences` VALUES ('1999', '1', 'euIiHqUbUYrKm5f4Q0hZDj7Fygtt2IvX', '2018-06-12 07:23:18', '2018-06-12 07:23:18');
INSERT INTO `persistences` VALUES ('2000', '1', 'Ku84zI0JD9qyG7NmD20AhCt9N4H16kDo', '2018-06-12 07:23:18', '2018-06-12 07:23:18');
INSERT INTO `persistences` VALUES ('2001', '1', 'sK9ra9lfp3J3PS3jzuTrq6Q0VxSOY4An', '2018-06-12 07:26:13', '2018-06-12 07:26:13');
INSERT INTO `persistences` VALUES ('2002', '1', 'KtZXkW4oSo1h7pT8ZvPK1usM5OL5AqKl', '2018-06-12 07:26:13', '2018-06-12 07:26:13');
INSERT INTO `persistences` VALUES ('2003', '1', 'EmapSaOtKvakTrsCJb9SinjjRLbC9OUU', '2018-06-12 07:27:08', '2018-06-12 07:27:08');
INSERT INTO `persistences` VALUES ('2004', '1', 'KUAHxJUW3KMMTQ17DPsnsoxqMvRhvqTb', '2018-06-12 07:27:11', '2018-06-12 07:27:11');
INSERT INTO `persistences` VALUES ('2005', '1', 'vpGCSYtvFvrSIVNvOarLBTKMH0mrwjIc', '2018-06-12 07:27:31', '2018-06-12 07:27:31');
INSERT INTO `persistences` VALUES ('2006', '1', '7ZunoERegqT2t5WWxaMg5jixEcl3KCgt', '2018-06-12 07:27:32', '2018-06-12 07:27:32');
INSERT INTO `persistences` VALUES ('2007', '1', 'jd7ukq4YZORt7Dil2GpGOQV914zKPKPj', '2018-06-12 07:29:29', '2018-06-12 07:29:29');
INSERT INTO `persistences` VALUES ('2008', '1', 'kcyzvjjX2ihrjiPEHEeySbgfxq181WGl', '2018-06-12 07:29:29', '2018-06-12 07:29:29');
INSERT INTO `persistences` VALUES ('2009', '1', '8RWuJYhPWn10Xaa2E4K7shi1N04Xw3dZ', '2018-06-12 07:30:39', '2018-06-12 07:30:39');
INSERT INTO `persistences` VALUES ('2010', '1', 'gRQmHZuOjE4RT6jfbKsYsPzMB8AYcQBE', '2018-06-12 07:30:39', '2018-06-12 07:30:39');
INSERT INTO `persistences` VALUES ('2011', '1', '1NMXt7LsNaKUyA09SIeppl6jnbS6ZuMz', '2018-06-12 07:31:08', '2018-06-12 07:31:08');
INSERT INTO `persistences` VALUES ('2012', '1', 'fqth1N2FMTW77ZhX7MAtPC1Fg41RZsYi', '2018-06-12 07:31:08', '2018-06-12 07:31:08');
INSERT INTO `persistences` VALUES ('2013', '1', 'EPuhzr9NKZ8ahyOFTKi9CoSJjwDT4zLl', '2018-06-12 07:36:15', '2018-06-12 07:36:15');
INSERT INTO `persistences` VALUES ('2014', '1', 'w9pewhmwrIsCjQwcPDfdAeNSIWUD9lBt', '2018-06-12 07:36:16', '2018-06-12 07:36:16');
INSERT INTO `persistences` VALUES ('2015', '1', '337Vde6CHOcpF3phPOgRDUCP4Q6YmeP6', '2018-06-12 07:39:01', '2018-06-12 07:39:01');
INSERT INTO `persistences` VALUES ('2016', '1', 'iGvIyEDNIaIYj8banY54Dx4AZfUyPyYi', '2018-06-12 07:39:01', '2018-06-12 07:39:01');
INSERT INTO `persistences` VALUES ('2017', '1', 'z3Otwtr8lyKb6UOnv4gXYLDcDzv8aGsF', '2018-06-12 07:40:51', '2018-06-12 07:40:51');
INSERT INTO `persistences` VALUES ('2018', '1', 'bHyyT51dKiTxjOUXmeH3Z7ZL1J8qFBIE', '2018-06-12 07:40:52', '2018-06-12 07:40:52');
INSERT INTO `persistences` VALUES ('2019', '1', 'mIzqmMxNSzxXgqefPUnL2DO3pch2pGwG', '2018-06-12 07:42:14', '2018-06-12 07:42:14');
INSERT INTO `persistences` VALUES ('2020', '1', '6zP5dDS2AIglyXPMjC0FC6rWaUJTEQN7', '2018-06-12 07:42:14', '2018-06-12 07:42:14');
INSERT INTO `persistences` VALUES ('2021', '1', 'mlts4hj3uMcLVNe7k51xYEjbM76oACRu', '2018-06-12 07:42:43', '2018-06-12 07:42:43');
INSERT INTO `persistences` VALUES ('2022', '1', 'CwgSOVkTUpnRHqXrdOOoPmuOKSnx8LNO', '2018-06-12 07:43:21', '2018-06-12 07:43:21');
INSERT INTO `persistences` VALUES ('2023', '1', '9f2c3wbRMwkHjvkVwJrcWyljNFmSFCS4', '2018-06-12 07:43:51', '2018-06-12 07:43:51');
INSERT INTO `persistences` VALUES ('2024', '1', 'zoycob8anbycllNpBPNQD7Bap4vx0vO7', '2018-06-12 07:43:52', '2018-06-12 07:43:52');
INSERT INTO `persistences` VALUES ('2025', '1', 'NcaLhp490oXNxzsR4NUERaaT3e4E2QSq', '2018-06-12 07:43:53', '2018-06-12 07:43:53');
INSERT INTO `persistences` VALUES ('2026', '1', 'Om3ki6w4s7E2EZmjlg8OjlFaaQfrnaMB', '2018-06-12 07:43:53', '2018-06-12 07:43:53');
INSERT INTO `persistences` VALUES ('2027', '1', 'Rrg8DeFIqzi3dAVHU34LaSfH2GPLwkaq', '2018-06-12 07:43:54', '2018-06-12 07:43:54');
INSERT INTO `persistences` VALUES ('2028', '1', 'M91kL5iQbVlzUXgnG5nEIxIR3KaT1kde', '2018-06-12 07:44:41', '2018-06-12 07:44:41');
INSERT INTO `persistences` VALUES ('2029', '1', 'dP4EUNjG5TXDs5mck8YLiEpXwzPdGYXB', '2018-06-12 07:44:42', '2018-06-12 07:44:42');
INSERT INTO `persistences` VALUES ('2030', '1', 'gHSivPV4W0h31pidbonXQq3XXW6b6OIt', '2018-06-12 07:46:36', '2018-06-12 07:46:36');
INSERT INTO `persistences` VALUES ('2031', '1', 'X1pjcrhg4F4uE2uzTz7ABw34Hphs9hB5', '2018-06-12 07:46:36', '2018-06-12 07:46:36');
INSERT INTO `persistences` VALUES ('2032', '1', 'wFTsOpzeaBqt6xWp6cYST0zM4HCD2hLJ', '2018-06-12 07:50:44', '2018-06-12 07:50:44');
INSERT INTO `persistences` VALUES ('2033', '1', 'S7tACXmOydSuvtxH4IoiSgjlM2IdzlZi', '2018-06-12 07:51:22', '2018-06-12 07:51:22');
INSERT INTO `persistences` VALUES ('2034', '1', 'boevhcYwFSKehpwSwvCmkSqSbPffmuBu', '2018-06-12 07:52:32', '2018-06-12 07:52:32');
INSERT INTO `persistences` VALUES ('2035', '1', 's5nDxlKcz7f0timfTHAWoeLqTnQPWaRS', '2018-06-12 07:52:33', '2018-06-12 07:52:33');
INSERT INTO `persistences` VALUES ('2036', '1', '2bIYu11VByv5dm6wa38UYeOiOpWsZCB7', '2018-06-12 07:52:53', '2018-06-12 07:52:53');
INSERT INTO `persistences` VALUES ('2037', '1', 'B83SntMl1oM9cmSQ9RfyG5lMPENjkeBt', '2018-06-12 07:52:53', '2018-06-12 07:52:53');
INSERT INTO `persistences` VALUES ('2039', '1', 'b0cnvdS4k7jWRpoesFvZ6xdSo0UIJ9r2', '2018-06-13 07:05:23', '2018-06-13 07:05:23');
INSERT INTO `persistences` VALUES ('2040', '1', 'ABjtbUYUxxqlVZC3AR1Vp9sxG3fPHGiD', '2018-06-13 07:05:24', '2018-06-13 07:05:24');
INSERT INTO `persistences` VALUES ('2041', '1', 'oVmhbOCrR9GGN9mOPi2ydv4WMPiEbEZS', '2018-06-13 07:05:25', '2018-06-13 07:05:25');
INSERT INTO `persistences` VALUES ('2042', '1', 'tTmVFyL651sJ10sE2LuTqB4qIdphzPjX', '2018-06-14 02:22:10', '2018-06-14 02:22:10');
INSERT INTO `persistences` VALUES ('2043', '1', 'QnSbHrEKOlXv91Z0eHwqy9Q9WqdIzybD', '2018-06-14 02:22:19', '2018-06-14 02:22:19');
INSERT INTO `persistences` VALUES ('2044', '1', 'IoSd6Bv1nHhxg5yiRzyBBKDeqZ5SjiH5', '2018-06-14 02:22:19', '2018-06-14 02:22:19');
INSERT INTO `persistences` VALUES ('2045', '1', 'dqgDPY8dUBtLaxj1SwhozLqLbNzUHVy7', '2018-06-14 02:22:19', '2018-06-14 02:22:19');
INSERT INTO `persistences` VALUES ('2046', '1', 'F9a3HZBO3LsoLaWfinnc9NFSVE3lYeN7', '2018-06-14 02:22:26', '2018-06-14 02:22:26');
INSERT INTO `persistences` VALUES ('2047', '1', 'e8WoMJ7pbvMk0EZIblFBb3dWSh8fX0cv', '2018-06-14 02:22:27', '2018-06-14 02:22:27');
INSERT INTO `persistences` VALUES ('2048', '1', 'YsM6tbDqnf6gubcbjy0i1oEfyjJchvbn', '2018-06-14 02:44:13', '2018-06-14 02:44:13');
INSERT INTO `persistences` VALUES ('2049', '1', 'Ij2NiwZdLtbpQxtKhgwxSOI9oYAVxYmF', '2018-06-14 02:44:19', '2018-06-14 02:44:19');
INSERT INTO `persistences` VALUES ('2050', '1', 'RpoIHIcO5iaSNdIxVCVdZNIo1ge4vJru', '2018-06-14 02:44:22', '2018-06-14 02:44:22');
INSERT INTO `persistences` VALUES ('2051', '1', 'njdr7JRQ8JMHPHHRvYREozDjHEa5wN7B', '2018-06-14 02:44:22', '2018-06-14 02:44:22');
INSERT INTO `persistences` VALUES ('2052', '1', 'S1RcX3lakq5FDd3KYBwzNRfdumsYX2lW', '2018-06-14 02:44:30', '2018-06-14 02:44:30');
INSERT INTO `persistences` VALUES ('2053', '1', '1jPzbZTwCEcApGlu334ztTEvkWfGCbfw', '2018-06-14 02:44:34', '2018-06-14 02:44:34');
INSERT INTO `persistences` VALUES ('2054', '1', 'XjJXvimS9bqftH9jBGZr0ga0cIRfuxVE', '2018-06-14 02:44:34', '2018-06-14 02:44:34');
INSERT INTO `persistences` VALUES ('2055', '1', 'XIRmkXkvq3rGigA3neZ6c2palgpdNEQ0', '2018-06-14 02:44:34', '2018-06-14 02:44:34');
INSERT INTO `persistences` VALUES ('2056', '1', 'AM23MWjpkh0QXHg67KSoexSaN6Z8Dmu6', '2018-06-14 02:44:38', '2018-06-14 02:44:38');
INSERT INTO `persistences` VALUES ('2057', '1', 'M0vZ5V5hxOFnv3zcnSOpzFqecivho3nA', '2018-06-14 02:44:39', '2018-06-14 02:44:39');
INSERT INTO `persistences` VALUES ('2058', '1', 'doD30z4L2NYwx1gqBpc5LH59Dsbs69Fu', '2018-06-14 02:44:57', '2018-06-14 02:44:57');
INSERT INTO `persistences` VALUES ('2059', '1', 'Xa6YlmtN9qsEyk059HZuTlR3e3S9vDyg', '2018-06-14 02:45:05', '2018-06-14 02:45:05');
INSERT INTO `persistences` VALUES ('2060', '1', 'QS3kMQFL1pMbxaVwJsIfunJ1SmvP8AxN', '2018-06-14 02:45:15', '2018-06-14 02:45:15');
INSERT INTO `persistences` VALUES ('2061', '1', 'uyZFrh0jQUkaVCKLJ7Prl4BMypgUrOBX', '2018-06-14 02:45:17', '2018-06-14 02:45:17');
INSERT INTO `persistences` VALUES ('2062', '1', 'rJrYrY2kdjHbs58SkxzyF294YN2oAtYE', '2018-06-14 02:45:18', '2018-06-14 02:45:18');
INSERT INTO `persistences` VALUES ('2063', '1', '0wGxY87LNGOLIpwur2YeanLZSl5PpbWI', '2018-06-14 02:45:18', '2018-06-14 02:45:18');
INSERT INTO `persistences` VALUES ('2064', '1', 'lY5PauQGGTfueoplhNg7Lg0BtBLrr6UY', '2018-06-14 02:46:14', '2018-06-14 02:46:14');
INSERT INTO `persistences` VALUES ('2065', '1', 'BJKXl7rP1o0XUkisdwWWdsAX1DjFR59x', '2018-06-14 02:46:14', '2018-06-14 02:46:14');
INSERT INTO `persistences` VALUES ('2066', '1', 'Zg96lD1X2dDQ2TLOhzvV8QAuDQcaphE8', '2018-06-14 02:46:15', '2018-06-14 02:46:15');
INSERT INTO `persistences` VALUES ('2067', '1', 'tIJayyjtLZhXTMATcIIZCKCKnPqDXgwA', '2018-06-14 02:46:28', '2018-06-14 02:46:28');
INSERT INTO `persistences` VALUES ('2068', '1', 'ubJpLXk7SkW2BOvUNfk7Ae55X3t4w2sa', '2018-06-14 02:46:30', '2018-06-14 02:46:30');
INSERT INTO `persistences` VALUES ('2069', '1', 'eJ7iam40VFliEIe8ju9Cy7ELaLUkmaMP', '2018-06-14 02:46:30', '2018-06-14 02:46:30');
INSERT INTO `persistences` VALUES ('2070', '1', 'C6ELNZAUfLhji1rSVzja5eWoQhbugNO4', '2018-06-14 02:46:31', '2018-06-14 02:46:31');
INSERT INTO `persistences` VALUES ('2071', '1', 'ifEHVROx4AgifxbpDNImU3Ra0xuG2Ne5', '2018-06-14 02:46:36', '2018-06-14 02:46:36');
INSERT INTO `persistences` VALUES ('2072', '1', 'c6OVj90UZcr8vA9dYqxdOa4XlaTznK25', '2018-06-14 02:46:36', '2018-06-14 02:46:36');
INSERT INTO `persistences` VALUES ('2073', '1', 'cBfGU4Mg8TeAv5RQdz9hivk71R6IV3iR', '2018-06-14 02:46:38', '2018-06-14 02:46:38');
INSERT INTO `persistences` VALUES ('2074', '1', 'xDsGJKfhZQ6yDDRGyWoOxyqXRvpYArmA', '2018-06-14 02:46:39', '2018-06-14 02:46:39');
INSERT INTO `persistences` VALUES ('2075', '1', 'WDZ3f9pfnzvveY1YF3iIqT7FQzzQvzgF', '2018-06-14 02:46:39', '2018-06-14 02:46:39');
INSERT INTO `persistences` VALUES ('2076', '1', 'TzBxoDdqjwe8C4QZ1ZqwnUG0K5ijrjQc', '2018-06-14 02:47:28', '2018-06-14 02:47:28');
INSERT INTO `persistences` VALUES ('2077', '1', 't5rOvGGooK64QdWew8XYreAn8H4qjYm7', '2018-06-14 02:47:28', '2018-06-14 02:47:28');
INSERT INTO `persistences` VALUES ('2078', '1', 'rMTBTXxPYCJ1QX6FJnGXEMiUJEWyzGLT', '2018-06-14 02:47:29', '2018-06-14 02:47:29');
INSERT INTO `persistences` VALUES ('2079', '1', 'sEEwvsrEvANPAXZybiQUBLcXrdxaN3Mk', '2018-06-14 02:47:36', '2018-06-14 02:47:36');
INSERT INTO `persistences` VALUES ('2080', '1', 'EiLNw2FBc8OjT1x7CKpPdQr892tEJhHn', '2018-06-14 02:47:37', '2018-06-14 02:47:37');
INSERT INTO `persistences` VALUES ('2081', '1', 's7n50Hlx0RD5SR816N3NF6scWaZKC9U9', '2018-06-14 02:47:37', '2018-06-14 02:47:37');
INSERT INTO `persistences` VALUES ('2082', '1', 'Q6GWb1g5Li66RvYu1fGUKCin8TPMi4GG', '2018-06-14 02:48:29', '2018-06-14 02:48:29');
INSERT INTO `persistences` VALUES ('2083', '1', 'bnYnW67hnKELloS6DzF5arU9QMBfK3xF', '2018-06-14 02:48:30', '2018-06-14 02:48:30');
INSERT INTO `persistences` VALUES ('2084', '1', 'KNRJcOPh1b82KCGHGLCmEzVdklVqCUe8', '2018-06-14 02:48:30', '2018-06-14 02:48:30');
INSERT INTO `persistences` VALUES ('2085', '1', 'xleAYCdfg3EOKXM7yc822T22FTy6ij2a', '2018-06-14 02:48:39', '2018-06-14 02:48:39');
INSERT INTO `persistences` VALUES ('2086', '1', 's9Zy9i8hdjEqzZrFHMAHx1naqaD9lCA7', '2018-06-14 02:48:40', '2018-06-14 02:48:40');
INSERT INTO `persistences` VALUES ('2087', '1', 'Lpks6LRzolUOpyCKLMgglDDiZIDih6ZC', '2018-06-14 02:48:50', '2018-06-14 02:48:50');
INSERT INTO `persistences` VALUES ('2088', '1', '2nYDZoCY0w8neKt4t9xg1OTCB8PsqdI6', '2018-06-14 02:48:51', '2018-06-14 02:48:51');
INSERT INTO `persistences` VALUES ('2089', '1', 'Va0ZcrCNidqjbf69hAJ0ObWCZR0Fin2N', '2018-06-14 02:48:51', '2018-06-14 02:48:51');
INSERT INTO `persistences` VALUES ('2090', '1', 'HZJOaWzwGaWetAln7TPSJLJuZICxW9Wb', '2018-06-14 02:50:51', '2018-06-14 02:50:51');
INSERT INTO `persistences` VALUES ('2091', '1', '3tfWPaVGJAeEVwuFtGF3iR9aITqjogrM', '2018-06-14 02:50:53', '2018-06-14 02:50:53');
INSERT INTO `persistences` VALUES ('2092', '1', 'dqPmbed9CwFLyXfrn5v7fmBtlgIQ353p', '2018-06-14 02:50:54', '2018-06-14 02:50:54');
INSERT INTO `persistences` VALUES ('2093', '1', 'kdOWSRX4Y49yFYauNu7Oct5ITbEeGJej', '2018-06-14 02:50:54', '2018-06-14 02:50:54');
INSERT INTO `persistences` VALUES ('2094', '1', 'iiyPUDOsjTqprZb9QNh2g48n7rgNn5oz', '2018-06-14 02:51:17', '2018-06-14 02:51:17');
INSERT INTO `persistences` VALUES ('2095', '1', '7rP2KXv9RIf9STouxeEDUkBt7xi9DAZP', '2018-06-14 02:51:17', '2018-06-14 02:51:17');
INSERT INTO `persistences` VALUES ('2096', '1', 'Sdjbi9hH2W396kLclwPASKOCZHSmhHWP', '2018-06-14 05:55:52', '2018-06-14 05:55:52');
INSERT INTO `persistences` VALUES ('2098', '9', 'nOlWJu8J6qHDGQXBSjQqCrHYUBbeNKsU', '2018-06-15 07:14:30', '2018-06-15 07:14:30');
INSERT INTO `persistences` VALUES ('2099', '1', 'X1OsxLeNbJixj9ezBebKckMPzFKbrZ8k', '2018-06-15 07:21:44', '2018-06-15 07:21:44');
INSERT INTO `persistences` VALUES ('2101', '1', 'yxs6JNicqqBtR9DP50UjgttcWesjRFQd', '2018-06-19 08:44:56', '2018-06-19 08:44:56');
INSERT INTO `persistences` VALUES ('2102', '1', 'DXRhfb2hlMPeAeJN3Ci9x6IUlh1EmpYH', '2018-06-19 08:44:59', '2018-06-19 08:44:59');
INSERT INTO `persistences` VALUES ('2104', '1', 'lkPI344g4rmQ4zAnFl0Gh37jcgghqN5y', '2018-06-19 09:45:37', '2018-06-19 09:45:37');
INSERT INTO `persistences` VALUES ('2106', '9', 'Up71dxxi3moVva8gNvPxj0oG5IT1TD8U', '2018-06-20 07:15:45', '2018-06-20 07:15:45');
INSERT INTO `persistences` VALUES ('2107', '1', 'Ybh1KZr4K3WTlD9xR4RsBUwFCwRMeYZD', '2018-06-21 06:50:25', '2018-06-21 06:50:25');
INSERT INTO `persistences` VALUES ('2108', '1', 'lHyxCxVuUvBrOsVtw77URgkPZz7HlInP', '2018-06-25 01:40:55', '2018-06-25 01:40:55');
INSERT INTO `persistences` VALUES ('2109', '1', 'ZL8ozNJlm5xstuuRrnNgR2VSpj6uFIdE', '2018-06-25 06:56:48', '2018-06-25 06:56:48');
INSERT INTO `persistences` VALUES ('2110', '1', 'nKxcm4AibQfjwzRimwt846fmZ8ryhooJ', '2018-06-25 09:36:39', '2018-06-25 09:36:39');
INSERT INTO `persistences` VALUES ('2111', '1', 'NG0GgMRv2eqP4Rlrk6r72dUdqIyQGQPh', '2018-06-26 01:36:47', '2018-06-26 01:36:47');
INSERT INTO `persistences` VALUES ('2112', '1', 'lFr6FsNelVJKtY3gyeQTIJ37bYVoXwMH', '2018-06-26 01:36:53', '2018-06-26 01:36:53');
INSERT INTO `persistences` VALUES ('2113', '1', '7XpF0c3xnTzXAzrPZGnw12Ujv44nLw2G', '2018-06-26 01:36:54', '2018-06-26 01:36:54');
INSERT INTO `persistences` VALUES ('2114', '1', 'ofqIq8i9MkgPRgm5LNFCXYwtqanBJ0HE', '2018-06-26 01:36:54', '2018-06-26 01:36:54');
INSERT INTO `persistences` VALUES ('2115', '1', 'u6ETqWnM0wjOmvrZfgVQLuwMUb3QXIN1', '2018-06-26 01:36:59', '2018-06-26 01:36:59');
INSERT INTO `persistences` VALUES ('2116', '1', 'dVt40YLnOLxitANYLkE1kNPpCmA4ae9d', '2018-06-26 01:36:59', '2018-06-26 01:36:59');
INSERT INTO `persistences` VALUES ('2117', '1', 'ND6IBAwFWrwcL71UY5CRTna58N4bqWwI', '2018-06-26 01:37:06', '2018-06-26 01:37:06');
INSERT INTO `persistences` VALUES ('2120', '9', 'G9CgZFFXlbuzCGSpBpgwUSK9oxmIDzCE', '2018-06-26 08:02:05', '2018-06-26 08:02:05');
INSERT INTO `persistences` VALUES ('2121', '1', 'yncH0kwGHGpuwxdIFawDupnNYVuiD4kA', '2018-06-26 09:29:13', '2018-06-26 09:29:13');
INSERT INTO `persistences` VALUES ('2122', '1', '97NQwskZvat5BrB59dfUPEwE062VdHry', '2018-06-26 09:29:15', '2018-06-26 09:29:15');
INSERT INTO `persistences` VALUES ('2123', '1', 'kI3tbJFvfDO33Q5zpLAz8vOTwINABgDI', '2018-06-26 09:29:16', '2018-06-26 09:29:16');
INSERT INTO `persistences` VALUES ('2124', '1', 'o7Mt063iMlLxXb0mpBGrWWJoEsHuP7Cy', '2018-06-26 09:29:16', '2018-06-26 09:29:16');
INSERT INTO `persistences` VALUES ('2126', '1', 'PyT4j7YmFE6Qf1lI0doCbB263ZqB1UbJ', '2018-06-26 09:30:55', '2018-06-26 09:30:55');
INSERT INTO `persistences` VALUES ('2127', '1', 'y85eGw77g6M3uO76jfVp1IEH8Bd2s6o6', '2018-06-26 09:30:56', '2018-06-26 09:30:56');
INSERT INTO `persistences` VALUES ('2128', '1', 'ptPIXqMnksUkfuTUsxBumhXAratQooA3', '2018-06-26 09:30:57', '2018-06-26 09:30:57');
INSERT INTO `persistences` VALUES ('2129', '1', 'B43ysWLZawD3L1vJ8wSfe9qRefUi1AG3', '2018-06-26 09:30:58', '2018-06-26 09:30:58');
INSERT INTO `persistences` VALUES ('2130', '1', 'BqlMAhMWcay0FuQIDRoiCoeeQHd7DWpg', '2018-06-26 09:33:42', '2018-06-26 09:33:42');
INSERT INTO `persistences` VALUES ('2131', '1', 'YRAYIS5gOZSLJK3SixUo7ucl0l9nAsiF', '2018-06-26 09:33:42', '2018-06-26 09:33:42');
INSERT INTO `persistences` VALUES ('2132', '1', 'JF3sg4GL2Oyw7Shcyb5fhTtA4cQtUuZX', '2018-06-26 09:33:43', '2018-06-26 09:33:43');
INSERT INTO `persistences` VALUES ('2133', '1', 'PuBM0pOGFYUteUPUMW2AbxUSbcefugCQ', '2018-06-26 09:34:12', '2018-06-26 09:34:12');
INSERT INTO `persistences` VALUES ('2134', '1', 'CbVqVsvYBKnMXtf9pqhYJK2ex9IJTIgA', '2018-06-26 09:34:13', '2018-06-26 09:34:13');
INSERT INTO `persistences` VALUES ('2135', '1', 'N2xqbeCJj8qPI2ekcTXfwK1QDa93N9ji', '2018-06-26 09:34:14', '2018-06-26 09:34:14');
INSERT INTO `persistences` VALUES ('2136', '1', 'XiBW1qmqBThCbNqTOD7XuHb2Puv2YYVV', '2018-06-26 09:34:59', '2018-06-26 09:34:59');
INSERT INTO `persistences` VALUES ('2137', '1', 'ru7Mn8grwdDHCdTEg2M4xujNthxaRsFy', '2018-06-26 09:35:00', '2018-06-26 09:35:00');
INSERT INTO `persistences` VALUES ('2138', '1', '9pIN3mjhdbASiAcAXS9By4RxJveIUvc3', '2018-06-26 09:35:00', '2018-06-26 09:35:00');
INSERT INTO `persistences` VALUES ('2139', '1', 'BqtFCXoMntEtkqR62xzVa1CKWDzfreXs', '2018-06-26 09:36:38', '2018-06-26 09:36:38');
INSERT INTO `persistences` VALUES ('2140', '1', 'aC1WFjEv0bG7n7QIm1xcd7pBzkrYq5Dm', '2018-06-26 09:36:39', '2018-06-26 09:36:39');
INSERT INTO `persistences` VALUES ('2141', '1', 'mc2l3fmxlwDPMMOlDREdgbJStwkLpABa', '2018-06-26 09:36:39', '2018-06-26 09:36:39');
INSERT INTO `persistences` VALUES ('2142', '1', 'lNJrXsh33kfITcIHIPY3EB1VCy9L0VWP', '2018-06-26 09:41:36', '2018-06-26 09:41:36');
INSERT INTO `persistences` VALUES ('2143', '1', 'jMXMBjPkAgQwTb8ileO7AUOESYA0Jitq', '2018-06-26 09:41:37', '2018-06-26 09:41:37');
INSERT INTO `persistences` VALUES ('2144', '1', 'Wmb8QmFCtcGUsztdGcoruHSiRn5OZdAT', '2018-06-26 09:41:37', '2018-06-26 09:41:37');
INSERT INTO `persistences` VALUES ('2145', '1', 'dRnPPQ5ETZXXKQunsv1szJlQQH596nid', '2018-06-26 09:41:45', '2018-06-26 09:41:45');
INSERT INTO `persistences` VALUES ('2146', '1', 'E8nVbzhCGTPVFP0nOtcdFZYtQ3rEBncj', '2018-06-26 09:41:46', '2018-06-26 09:41:46');
INSERT INTO `persistences` VALUES ('2147', '1', 'dwFg1iS0EUOcxLlZhlKcqjQLUwLZoYzf', '2018-06-26 09:41:46', '2018-06-26 09:41:46');
INSERT INTO `persistences` VALUES ('2148', '1', 'sLBCTlgGQEYNJhsOxdCOh0X80lDtFFeC', '2018-06-26 09:42:00', '2018-06-26 09:42:00');
INSERT INTO `persistences` VALUES ('2149', '1', 'eNFvzMUnkuH9IXcnvYM5sAASSnHfpHaL', '2018-06-26 09:42:01', '2018-06-26 09:42:01');
INSERT INTO `persistences` VALUES ('2150', '1', 'wJ0cNTGvkcbgEnmRkBOJATXu7CWt12OA', '2018-06-26 09:42:01', '2018-06-26 09:42:01');
INSERT INTO `persistences` VALUES ('2151', '1', 'Jzf4hP3TFIGcXaj4qCBFWmrAQmTAPJ7F', '2018-06-26 09:42:12', '2018-06-26 09:42:12');
INSERT INTO `persistences` VALUES ('2152', '1', 'ThuyGDern41fb9tjB9f5z7k6w2c322m5', '2018-06-26 09:42:12', '2018-06-26 09:42:12');
INSERT INTO `persistences` VALUES ('2153', '1', 'khXLSXra6tp9yo9dNFdw6rw3XbTTQ6DD', '2018-06-26 09:42:13', '2018-06-26 09:42:13');
INSERT INTO `persistences` VALUES ('2154', '1', 'qq8JWbXBR0UccBa8k4fg19QxZx8H0mqM', '2018-06-26 09:42:31', '2018-06-26 09:42:31');
INSERT INTO `persistences` VALUES ('2155', '1', 'jDAV4fqFNwzIaWOEwQhKebl3WaeMechg', '2018-06-26 09:42:32', '2018-06-26 09:42:32');
INSERT INTO `persistences` VALUES ('2156', '1', 'b8P2SNYIVFB82qRb1rnnaJ8nPgZVsEjN', '2018-06-26 09:42:33', '2018-06-26 09:42:33');
INSERT INTO `persistences` VALUES ('2157', '1', 'pivv0iyFkLoGdQG6mWq2B5Q9ODP9yTqn', '2018-06-26 09:42:44', '2018-06-26 09:42:44');
INSERT INTO `persistences` VALUES ('2158', '1', 'pelI3HTHKMzOYH9ESa0EERpJKcu4cXts', '2018-06-26 09:42:45', '2018-06-26 09:42:45');
INSERT INTO `persistences` VALUES ('2159', '1', '1Lw7WY63jwhmYnjE51obBTlH0IfbyujI', '2018-06-26 09:42:46', '2018-06-26 09:42:46');
INSERT INTO `persistences` VALUES ('2160', '1', 'BkBD2wDUrPTfykGQevskfB8Oc6y2MFfh', '2018-06-26 09:43:24', '2018-06-26 09:43:24');
INSERT INTO `persistences` VALUES ('2161', '1', '3n8yjsdpzHxdP4qyzfHSURblNbu7KMvJ', '2018-06-26 09:43:24', '2018-06-26 09:43:24');
INSERT INTO `persistences` VALUES ('2162', '1', 'hHFPryMDykiViVs6QDkrgJU6eMI79eMO', '2018-06-26 09:43:25', '2018-06-26 09:43:25');
INSERT INTO `persistences` VALUES ('2163', '1', 'VWmcZZmtdwlFh86sXhGzeF0VyGnA4una', '2018-06-26 09:43:52', '2018-06-26 09:43:52');
INSERT INTO `persistences` VALUES ('2164', '1', '4PEpKb6iNn8uCwlv6L0WcjQ8ln8X28Bd', '2018-06-26 09:43:52', '2018-06-26 09:43:52');
INSERT INTO `persistences` VALUES ('2165', '1', 'kGm5HI1A5yqpf88YOxy5iL2W3LuGPpPu', '2018-06-26 09:43:53', '2018-06-26 09:43:53');
INSERT INTO `persistences` VALUES ('2166', '1', 'mziaCyKjB7DgaOL1TWf2Zo5TrwAzEz6J', '2018-06-26 09:57:56', '2018-06-26 09:57:56');
INSERT INTO `persistences` VALUES ('2167', '1', 'YOixRvDlq07cup5IkaNFbnrGjW77ndK6', '2018-06-26 09:57:56', '2018-06-26 09:57:56');
INSERT INTO `persistences` VALUES ('2168', '1', 'ns90wEIrbMbhoMElcJboqrtXBy9m1HJt', '2018-06-26 09:59:47', '2018-06-26 09:59:47');
INSERT INTO `persistences` VALUES ('2169', '1', 'tcEzYqQ26gnBGjv7v9c1B7saEab5I5P0', '2018-06-26 09:59:48', '2018-06-26 09:59:48');
INSERT INTO `persistences` VALUES ('2170', '1', 'bgiypRYs0qxpZokE4ZOIyPPUTT5DYEbn', '2018-06-26 09:59:48', '2018-06-26 09:59:48');
INSERT INTO `persistences` VALUES ('2171', '1', 'PROUDmH2kDDTZCwKcxS1afGmsp016o98', '2018-06-26 09:59:59', '2018-06-26 09:59:59');
INSERT INTO `persistences` VALUES ('2172', '1', 'XIMfWH8nsMntzpFuNHoGNif48bsp9EQH', '2018-06-26 10:00:00', '2018-06-26 10:00:00');
INSERT INTO `persistences` VALUES ('2173', '1', 'b3Qh5aeAGo8P8izabjqYyKu49PQhvOok', '2018-06-26 10:02:29', '2018-06-26 10:02:29');
INSERT INTO `persistences` VALUES ('2174', '1', '5F88IFpYgIq9wFtMQbT64gNh9BmXcnT8', '2018-06-27 00:59:04', '2018-06-27 00:59:04');
INSERT INTO `persistences` VALUES ('2175', '1', '8bjtgRqRiRtlaVLZAOBAqtX65GGoOjcx', '2018-06-27 01:23:34', '2018-06-27 01:23:34');
INSERT INTO `persistences` VALUES ('2176', '1', 'U9MpSvzOV6Njc3k0eKKMKVHuReNRecoN', '2018-06-27 01:24:03', '2018-06-27 01:24:03');
INSERT INTO `persistences` VALUES ('2178', '1', 'fazgtSDdE8WVw1I9SgmM7ji4uewP3kPT', '2018-06-27 02:02:10', '2018-06-27 02:02:10');
INSERT INTO `persistences` VALUES ('2186', '10', 'HMbsFrGb1sPmfMnDu3pFpmJjlh338Gug', '2018-06-27 09:53:12', '2018-06-27 09:53:12');
INSERT INTO `persistences` VALUES ('2187', '11', 'BSJPe52Qh2nSgX457DqAba3UF9iE5PLr', '2018-06-27 09:59:01', '2018-06-27 09:59:01');
INSERT INTO `persistences` VALUES ('2189', '1', 'e8FwFdHP1u7WuoKGyVOy01m006CI0pRa', '2018-06-28 01:20:52', '2018-06-28 01:20:52');
INSERT INTO `persistences` VALUES ('2190', '1', 'ZlhgZAjCbvTCdrqZu8PeylknAoOl7Uju', '2018-06-28 01:20:59', '2018-06-28 01:20:59');
INSERT INTO `persistences` VALUES ('2191', '1', 'Z2sYgBb1fjKCk2wY30hooBk5d1DWRoXf', '2018-06-28 01:21:00', '2018-06-28 01:21:00');
INSERT INTO `persistences` VALUES ('2192', '1', 'V43u393Ovu7DV4QnDYVoGMi5ZFp6BG7V', '2018-06-28 01:21:00', '2018-06-28 01:21:00');
INSERT INTO `persistences` VALUES ('2193', '1', 'Dl7In5tHbIdN3IIwUtEs8q0Zz3FihqAK', '2018-06-28 01:21:17', '2018-06-28 01:21:17');
INSERT INTO `persistences` VALUES ('2194', '1', 'AdeS7WrH2PZeayIsyoUBXpUx3TL2Fk2B', '2018-06-28 01:21:19', '2018-06-28 01:21:19');
INSERT INTO `persistences` VALUES ('2195', '1', 'AjCwMV4elPANZuPnrIirpa8zrvWLmsLq', '2018-06-28 01:21:19', '2018-06-28 01:21:19');
INSERT INTO `persistences` VALUES ('2196', '1', 'sa3VhRBRcwvGIK7jh4F2FQC3piThe9Pz', '2018-06-28 01:21:20', '2018-06-28 01:21:20');
INSERT INTO `persistences` VALUES ('2197', '1', 'ERNwTlloRbEPf3tpmN7wbdRivaAuvjM8', '2018-06-28 01:21:35', '2018-06-28 01:21:35');
INSERT INTO `persistences` VALUES ('2198', '1', 'AcRWnbgw7596SMI7ymxqT8VX0VtbzurC', '2018-06-28 01:21:37', '2018-06-28 01:21:37');
INSERT INTO `persistences` VALUES ('2199', '1', 'NamRZuY6IqrWUJntpHhyJdL8HSW7qbv8', '2018-06-28 01:21:38', '2018-06-28 01:21:38');
INSERT INTO `persistences` VALUES ('2200', '1', 'oztUlw36QvWPrwa2lUmCU1y0QVs0Tetd', '2018-06-28 01:21:38', '2018-06-28 01:21:38');
INSERT INTO `persistences` VALUES ('2201', '1', 'yCuJR2YsrxkenVwwZCesW8dRvGHxt2bV', '2018-06-28 01:21:41', '2018-06-28 01:21:41');
INSERT INTO `persistences` VALUES ('2202', '1', 'wbHO3FOv0HhCozzfnu8cLdCdRSXKPGkK', '2018-06-28 01:21:43', '2018-06-28 01:21:43');
INSERT INTO `persistences` VALUES ('2203', '1', '6N3efoZmpS6yD3NLA3XqO45xmmwAiRlq', '2018-06-28 01:21:44', '2018-06-28 01:21:44');
INSERT INTO `persistences` VALUES ('2204', '1', 'GgVFWE84jMQ5OMpyXhQt1Xq76ztNFkGS', '2018-06-28 01:21:44', '2018-06-28 01:21:44');
INSERT INTO `persistences` VALUES ('2205', '1', 'NWQNXrzQwdowPWGUYQA1ccXVu6KfMTfm', '2018-06-28 01:21:49', '2018-06-28 01:21:49');
INSERT INTO `persistences` VALUES ('2206', '1', 'VFvprufwHfxbCrgMgu4DxDBxd8e2OPDJ', '2018-06-28 01:24:21', '2018-06-28 01:24:21');
INSERT INTO `persistences` VALUES ('2207', '1', 'wrUAnfswLfgweKdF1DFzD7GAQ0CjyISb', '2018-06-28 01:25:09', '2018-06-28 01:25:09');
INSERT INTO `persistences` VALUES ('2208', '20', 'S54fZUMwAEYWfUbQ7JJjMkeQtNdoQCKT', '2018-06-28 01:48:30', '2018-06-28 01:48:30');
INSERT INTO `persistences` VALUES ('2209', '22', 'VrMpjbzhG2QvrxtfZBgerCZhwY8ix2IB', '2018-06-28 02:01:59', '2018-06-28 02:01:59');
INSERT INTO `persistences` VALUES ('2214', '1', 'NKl1AMYEXWNbHfJnHv6laVuAM8n3725j', '2018-06-28 09:04:12', '2018-06-28 09:04:12');
INSERT INTO `persistences` VALUES ('2215', '1', 'jB70OTS370uoaK5tZAiIUdSKZ6gE00sA', '2018-06-28 09:04:19', '2018-06-28 09:04:19');
INSERT INTO `persistences` VALUES ('2216', '1', 'kcIN2sWu8NYBHZIxZlKKyuxleMLfJ9j5', '2018-06-28 09:04:26', '2018-06-28 09:04:26');
INSERT INTO `persistences` VALUES ('2217', '9', 'AXmq6dlnNHXQFT7MbGYRBvicjaODK8Qj', '2018-06-28 09:04:44', '2018-06-28 09:04:44');
...
CREATE TABLE `product_comments` (
  ...
  `goods_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `goods_options` text COLLATE utf8mb4_unicode_ci,
  `user_id` int(11) NOT NULL,
  `goods_score` double(8,2) DEFAULT NULL,
  `pId` int(11) NOT NULL DEFAULT '0',
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_show` tinyint(1) NOT NULL,
  `appraise_img_path` text COLLATE utf8mb4_unicode_ci,
...
-- ----------------------------
INSERT INTO `product_comments` VALUES ('1', '2018061505211', '6', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '9', '5.00', '0', 'Good quality, I ordered big, expected it to run small but I should of just got my true size. Very pretty cant wait to wear it in my friends wedding!', '1', '2018-06-15-07-54-27-5b2370b338cde.jpg;2018-06-15-07-54-27-5b2370b33a734.jpg', '5', '0', '2018-06-15 07:54:27', '2018-06-15 07:54:27');
INSERT INTO `product_comments` VALUES ('2', '2018061505211', '6', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u7ea2\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":2}', '9', '5.00', '0', 'Lovely dress, but had no where to wear it too!', '0', '2018-06-15-07-54-27-5b2370b33e9ac.jpg;2018-06-15-07-54-27-5b2370b33fe01.jpg', '0', '0', '2018-06-15 07:54:27', '2018-06-15 07:54:27');
INSERT INTO `product_comments` VALUES ('3', '2018062046075', '6', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '9', '5.00', '0', 'good', '0', '', '0', '0', '2018-06-20 09:20:13', '2018-06-20 09:20:13');
INSERT INTO `product_comments` VALUES ('4', '2018062046075', '7', '{\"sku_options\":{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u76ae\\u9769\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-06-44-19-5b1f6bc31ade0_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-black-dress\",\"userId\":9,\"index\":2}', '9', '5.00', '0', 'very good', '0', '', '0', '0', '2018-06-20 09:20:13', '2018-06-20 09:20:13');
INSERT INTO `product_comments` VALUES ('5', '2018062153805', '6', '{\"sku_options\":{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\"},\"selectedItemLocale\":{\"\\u6750\\u8d28\":\"\\u7f8a\\u6bdb\",\"\\u54c1\\u724c\":\"ZARA\",\"\\u989c\\u8272\":\"\\u84dd\\u8272\",\"\\u5c3a\\u7801\":\"\\u4e2d\\u7801\"},\"selected\":true,\"image\":\"http:\\/\\/localhost:8000\\/assets\\/media\\/2018-06-12-07-43-52-5b1f79b85edde_smallThumb.jpg\",\"slug\":\"\\/product\\/casual-women-suits\",\"userId\":9,\"index\":1}', '9', '5.00', '0', 'I like the dress', '0', '2018-06-21-03-20-14-5b2b196e75e1b.jpg', '0', '0', '2018-06-21 03:20:14', '2018-06-21 03:20:14');

-- ----------------------------
-- Table structure for product_comments_reply
-- ----------------------------
DROP TABLE IF EXISTS `product_comments_reply`;
CREATE TABLE `product_comments_reply` (
  ...
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `has_read` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `read_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `dialog_id` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ----------------------------
-- Records of product_comments_reply
-- ----------------------------
INSERT INTO `product_comments_reply` VALUES ('10', '1', '1', '1', '9', 'Hello! Thank you so much for uploading your photo with us. I\'m gratified to know that you are satisfied with this blue shirt. If you like it, you can share your good experience with your friends, that\'d be really kind of you! Again, we wish to really thank you for your kindness!', 'T', '2018-06-26 08:02:15', '1-9', '2018-06-26 08:01:36', '2018-06-26 08:02:15');
...
-- ----------------------------
INSERT INTO `product__attrs` VALUES ('45', '7', 'material', '[\"leather\"]', '1', '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__attrs` VALUES ('46', '7', 'brand', '[\"zara\"]', '1', '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__attrs` VALUES ('47', '7', 'color', '[\"blue\",\"red\"]', '1', '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__attrs` VALUES ('48', '7', 'size', '[\"m\",\"l\"]', '1', '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__attrs` VALUES ('49', '6', 'material', '[\"mutton\",\"leather\"]', '1', '2018-06-12 07:53:04', '2018-06-12 07:53:04');
INSERT INTO `product__attrs` VALUES ('50', '6', 'brand', '[\"zara\"]', '1', '2018-06-12 07:53:04', '2018-06-12 07:53:04');
INSERT INTO `product__attrs` VALUES ('51', '6', 'color', '[\"blue\",\"red\"]', '1', '2018-06-12 07:53:04', '2018-06-12 07:53:04');
INSERT INTO `product__attrs` VALUES ('52', '6', 'size', '[\"m\"]', '1', '2018-06-12 07:53:04', '2018-06-12 07:53:04');
...
CREATE TABLE `product__attrset_translations` (
  ...
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product__attrset_translations_attrset_id_locale_unique` (`attrset_id`,`locale`) USING BTREE,
  KEY `product__attrset_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `product__attrset_translations_ibfk_1` FOREIGN KEY (`attrset_id`) REFERENCES `product__attrsets` (`id`) ON DELETE CASCADE
...
CREATE TABLE `product__attr_translations` (
  ...
  `locale` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product__attr_translations_attr_id_locale_unique` (`attr_id`,`locale`) USING BTREE,
  KEY `product__attr_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `product__attr_translations_ibfk_1` FOREIGN KEY (`attr_id`) REFERENCES `product__attrs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product__category_translations` (
  ...
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product__category_translations_category_id_locale_unique` (`category_id`,`locale`) USING BTREE,
  KEY `product__category_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `product__category_translations_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `product__categories` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product__products` (
  ...
  PRIMARY KEY (`id`),
  KEY `product__products_attrset_id_index` (`attrset_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of product__products
-- ----------------------------
INSERT INTO `product__products` VALUES ('6', '3', '0', '0', '230.00', '920', '2018-06-12 07:44:30', '2018-06-12 07:53:04', '{}');
INSERT INTO `product__products` VALUES ('7', '3', '0', '0', '128.00', '512', '2018-06-12 07:51:54', '2018-06-12 07:52:38', '{}');
...
CREATE TABLE `product__products_cats` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product__products_cats_product_id_index` (`product_id`) USING BTREE,
  KEY `product__products_cats_category_id_index` (`category_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `product__products_cats` VALUES ('50', '5', '2', null, null);
INSERT INTO `product__products_cats` VALUES ('51', '6', '2', null, null);
INSERT INTO `product__products_cats` VALUES ('52', '7', '2', null, null);
...
CREATE TABLE `product__product_translations` (
  ...
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product__product_translations_product_id_locale_unique` (`product_id`,`locale`) USING BTREE,
  KEY `product__product_translations_locale_index` (`locale`) USING BTREE,
  CONSTRAINT `product__product_translations_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product__products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of product__product_translations
-- ----------------------------
INSERT INTO `product__product_translations` VALUES ('8', '休闲套装女', 'casual-women-suits', 'casual-women-suits', '<p>casual-women-suits</p>', '6', 'zh', 'casual-women-suits');
INSERT INTO `product__product_translations` VALUES ('9', 'casual-black-dress', 'casual-black-dress', 'casual-black-dress', '<p>casual-black-dress</p>', '7', 'en', 'casual-black-dress');
INSERT INTO `product__product_translations` VALUES ('10', '黑色休闲长裙', '230', '230', '<p>casual black t shirt</p>', '7', 'zh', 'casual-black-dress');
INSERT INTO `product__product_translations` VALUES ('11', 'casual-women-suits', 'casual-women-suits', 'casual-women-suits', '<p>casual-women-suits</p>', '6', 'en', 'casual-women-suits');
...
-- ----------------------------
INSERT INTO `product__skus` VALUES ('63', '7', '{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"l\",\"price\":\"128\",\"stock\":\"128\"}', null, '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__skus` VALUES ('64', '7', '{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"m\",\"price\":\"128\",\"stock\":\"128\"}', null, '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__skus` VALUES ('65', '7', '{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"l\",\"price\":\"128\",\"stock\":\"128\"}', null, '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__skus` VALUES ('66', '7', '{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\",\"price\":\"128\",\"stock\":\"128\"}', null, '2018-06-12 07:52:38', '2018-06-12 07:52:38');
INSERT INTO `product__skus` VALUES ('67', '6', '{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"m\",\"price\":\"230\",\"stock\":\"230\"}', null, '2018-06-12 07:53:04', '2018-06-12 07:53:04');
INSERT INTO `product__skus` VALUES ('68', '6', '{\"material\":\"leather\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\",\"price\":\"230\",\"stock\":\"230\"}', null, '2018-06-12 07:53:04', '2018-06-12 07:53:04');
INSERT INTO `product__skus` VALUES ('69', '6', '{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"red\",\"size\":\"m\",\"price\":\"230\",\"stock\":\"230\"}', null, '2018-06-12 07:53:04', '2018-06-12 07:53:04');
INSERT INTO `product__skus` VALUES ('70', '6', '{\"material\":\"mutton\",\"brand\":\"zara\",\"color\":\"blue\",\"size\":\"m\",\"price\":\"230\",\"stock\":\"230\"}', null, '2018-06-12 07:53:04', '2018-06-12 07:53:04');
...
INSERT INTO `role_users` VALUES ('9', '2', '2018-05-21 02:51:07', '2018-05-21 02:51:07');
...
INSERT INTO `setting__settings` VALUES ('7', 'currency::default-currency', 'USD', '0', '2018-05-17 06:17:54', '2018-05-17 07:41:30');
INSERT INTO `setting__settings` VALUES ('8', 'currency::allowed-currencies', '[\"CNY\",\"EUR\",\"GBP\",\"USD\"]', '0', '2018-05-17 06:17:54', '2018-05-18 02:48:46');
INSERT INTO `setting__settings` VALUES ('11', 'currency::current-currency', '[\"EUR\"]', '0', '2018-05-18 06:12:31', '2018-05-18 06:20:29');
INSERT INTO `setting__settings` VALUES ('12', 'blog::posts-per-page', null, '1', '2018-05-18 06:27:04', '2018-05-18 06:27:04');
INSERT INTO `setting__settings` VALUES ('13', 'blog::latest-posts-amount', null, '1', '2018-05-18 06:27:05', '2018-05-18 06:27:05');
INSERT INTO `setting__settings` VALUES ('14', 'blog::widget-posts-amount', null, '1', '2018-05-18 06:27:05', '2018-05-18 06:27:05');
...
INSERT INTO `setting__setting_translations` VALUES ('4', '12', 'en', null, null);
INSERT INTO `setting__setting_translations` VALUES ('5', '12', 'zh', null, null);
INSERT INTO `setting__setting_translations` VALUES ('6', '13', 'en', null, null);
INSERT INTO `setting__setting_translations` VALUES ('7', '13', 'zh', null, null);
INSERT INTO `setting__setting_translations` VALUES ('8', '14', 'en', null, null);
INSERT INTO `setting__setting_translations` VALUES ('9', '14', 'zh', null, null);
...
-- ----------------------------
INSERT INTO `shoppingcart` VALUES ('1', 'cart', 'O:29:\"Illuminate\\Support\\Collection\":1:{s:8:\"\0*\0items\";a:0:{}}', null, '0', null, '2018-06-13 08:21:53');
INSERT INTO `shoppingcart` VALUES ('9', 'cart', 'O:29:\"Illuminate\\Support\\Collection\":1:{s:8:\"\0*\0items\";a:0:{}}', null, '0', null, '2018-06-28 09:47:32');
...
INSERT INTO `throttle` VALUES ('4', null, 'global', null, '2018-05-15 07:21:58', '2018-05-15 07:21:58');
INSERT INTO `throttle` VALUES ('5', null, 'ip', '127.0.0.1', '2018-05-15 07:21:58', '2018-05-15 07:21:58');
INSERT INTO `throttle` VALUES ('6', '1', 'user', null, '2018-05-15 07:21:58', '2018-05-15 07:21:58');
INSERT INTO `throttle` VALUES ('7', null, 'global', null, '2018-05-21 04:01:36', '2018-05-21 04:01:36');
INSERT INTO `throttle` VALUES ('8', null, 'ip', '127.0.0.1', '2018-05-21 04:01:37', '2018-05-21 04:01:37');
INSERT INTO `throttle` VALUES ('9', '1', 'user', null, '2018-05-21 04:01:37', '2018-05-21 04:01:37');
INSERT INTO `throttle` VALUES ('10', null, 'global', null, '2018-05-21 04:01:44', '2018-05-21 04:01:44');
INSERT INTO `throttle` VALUES ('11', null, 'ip', '127.0.0.1', '2018-05-21 04:01:44', '2018-05-21 04:01:44');
INSERT INTO `throttle` VALUES ('12', '1', 'user', null, '2018-05-21 04:01:44', '2018-05-21 04:01:44');
INSERT INTO `throttle` VALUES ('13', null, 'global', null, '2018-05-21 04:02:02', '2018-05-21 04:02:02');
INSERT INTO `throttle` VALUES ('14', null, 'ip', '127.0.0.1', '2018-05-21 04:02:02', '2018-05-21 04:02:02');
INSERT INTO `throttle` VALUES ('15', '1', 'user', null, '2018-05-21 04:02:02', '2018-05-21 04:02:02');
INSERT INTO `throttle` VALUES ('16', null, 'global', null, '2018-05-21 04:02:09', '2018-05-21 04:02:09');
INSERT INTO `throttle` VALUES ('17', null, 'ip', '127.0.0.1', '2018-05-21 04:02:09', '2018-05-21 04:02:09');
INSERT INTO `throttle` VALUES ('18', '9', 'user', null, '2018-05-21 04:02:09', '2018-05-21 04:02:09');
INSERT INTO `throttle` VALUES ('19', null, 'global', null, '2018-06-25 01:40:44', '2018-06-25 01:40:44');
INSERT INTO `throttle` VALUES ('20', null, 'ip', '127.0.0.1', '2018-06-25 01:40:44', '2018-06-25 01:40:44');
INSERT INTO `throttle` VALUES ('21', '1', 'user', null, '2018-06-25 01:40:44', '2018-06-25 01:40:44');
INSERT INTO `throttle` VALUES ('22', null, 'global', null, '2018-06-27 01:49:05', '2018-06-27 01:49:05');
INSERT INTO `throttle` VALUES ('23', null, 'ip', '127.0.0.1', '2018-06-27 01:49:05', '2018-06-27 01:49:05');
INSERT INTO `throttle` VALUES ('24', '1', 'user', null, '2018-06-27 01:49:05', '2018-06-27 01:49:05');
INSERT INTO `throttle` VALUES ('25', null, 'global', null, '2018-06-27 02:13:52', '2018-06-27 02:13:52');
INSERT INTO `throttle` VALUES ('26', null, 'ip', '127.0.0.1', '2018-06-27 02:13:52', '2018-06-27 02:13:52');
INSERT INTO `throttle` VALUES ('27', '1', 'user', null, '2018-06-27 02:13:52', '2018-06-27 02:13:52');
INSERT INTO `throttle` VALUES ('28', null, 'global', null, '2018-06-27 02:14:33', '2018-06-27 02:14:33');
INSERT INTO `throttle` VALUES ('29', null, 'ip', '127.0.0.1', '2018-06-27 02:14:33', '2018-06-27 02:14:33');
INSERT INTO `throttle` VALUES ('30', '1', 'user', null, '2018-06-27 02:14:33', '2018-06-27 02:14:33');
INSERT INTO `throttle` VALUES ('31', null, 'global', null, '2018-06-27 02:46:54', '2018-06-27 02:46:54');
INSERT INTO `throttle` VALUES ('32', null, 'ip', '127.0.0.1', '2018-06-27 02:46:54', '2018-06-27 02:46:54');
INSERT INTO `throttle` VALUES ('33', '1', 'user', null, '2018-06-27 02:46:54', '2018-06-27 02:46:54');
INSERT INTO `throttle` VALUES ('34', null, 'global', null, '2018-06-27 06:17:43', '2018-06-27 06:17:43');
INSERT INTO `throttle` VALUES ('35', null, 'ip', '127.0.0.1', '2018-06-27 06:17:43', '2018-06-27 06:17:43');
INSERT INTO `throttle` VALUES ('36', '1', 'user', null, '2018-06-27 06:17:43', '2018-06-27 06:17:43');
INSERT INTO `throttle` VALUES ('37', null, 'global', null, '2018-06-28 09:02:37', '2018-06-28 09:02:37');
INSERT INTO `throttle` VALUES ('38', null, 'ip', '127.0.0.1', '2018-06-28 09:02:37', '2018-06-28 09:02:37');
INSERT INTO `throttle` VALUES ('39', '9', 'user', null, '2018-06-28 09:02:37', '2018-06-28 09:02:37');
...
CREATE TABLE `users` (
  ...
  `account_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '第三方返回的id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_account_id_unique` (`account_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', '2861166132@qq.com', '$2y$10$IFS9tS0p7ikRJn3QXjuEEOFjOGxI4QbnC5Cllm9BoJYOokoPjX1Zq', '{\"attribute.attributes.index\":true,\"attribute.attributes.create\":true,\"attribute.attributes.edit\":true,\"attribute.attributes.destroy\":true,\"blog.posts.index\":true,\"blog.posts.create\":true,\"blog.posts.edit\":true,\"blog.posts.destroy\":true,\"blog.categories.index\":true,\"blog.categories.create\":true,\"blog.categories.edit\":true,\"blog.categories.destroy\":true,\"core.sidebar.group\":true,\"currency.currencies.index\":true,\"currency.currencies.create\":true,\"currency.currencies.edit\":true,\"currency.currencies.destroy\":true,\"dashboard.index\":true,\"dashboard.update\":true,\"dashboard.reset\":true,\"media.medias.index\":true,\"media.medias.create\":true,\"media.medias.edit\":true,\"media.medias.destroy\":true,\"media.folders.index\":true,\"media.folders.create\":true,\"media.folders.edit\":true,\"media.folders.destroy\":true,\"menu.menus.index\":true,\"menu.menus.create\":true,\"menu.menus.edit\":true,\"menu.menus.destroy\":true,\"menu.menuitems.index\":true,\"menu.menuitems.create\":true,\"menu.menuitems.edit\":true,\"menu.menuitems.destroy\":true,\"notify.messages.index\":true,\"notify.messages.create\":true,\"notify.messages.edit\":true,\"notify.messages.destroy\":true,\"page.pages.index\":true,\"page.pages.create\":true,\"page.pages.edit\":true,\"page.pages.destroy\":true,\"product.attrsets.index\":true,\"product.attrsets.create\":true,\"product.attrsets.edit\":true,\"product.attrsets.destroy\":true,\"product.products.index\":true,\"product.products.create\":true,\"product.products.edit\":true,\"product.products.destroy\":true,\"product.categories.index\":true,\"product.categories.create\":true,\"product.categories.edit\":true,\"product.categories.destroy\":true,\"product.images.index\":true,\"product.images.create\":true,\"product.images.edit\":true,\"product.images.destroy\":true,\"product.skus.index\":true,\"product.skus.create\":true,\"product.skus.edit\":true,\"product.skus.destroy\":true,\"product.attrs.index\":true,\"product.attrs.create\":true,\"product.attrs.edit\":true,\"product.attrs.destroy\":true,\"sale.saleorders.index\":true,\"sale.saleorders.create\":true,\"sale.saleorders.edit\":true,\"sale.saleorders.destroy\":true,\"sale.orderrefunds.index\":true,\"sale.orderrefunds.create\":true,\"sale.orderrefunds.edit\":true,\"sale.orderrefunds.destroy\":true,\"sale.orderreturns.index\":true,\"sale.orderreturns.create\":true,\"sale.orderreturns.edit\":true,\"sale.orderreturns.destroy\":true,\"sale.comments.index\":true,\"sale.comments.create\":true,\"sale.comments.edit\":true,\"sale.comments.destroy\":true,\"sale.orderreviews.index\":true,\"sale.orderreviews.create\":true,\"sale.orderreviews.edit\":true,\"sale.orderreviews.destroy\":true,\"sale.orders.index\":true,\"sale.orders.create\":true,\"sale.orders.edit\":true,\"sale.orders.destroy\":true,\"sale.transactions.index\":true,\"sale.transactions.create\":true,\"sale.transactions.edit\":true,\"sale.transactions.destroy\":true,\"sale.invoices.index\":true,\"sale.invoices.create\":true,\"sale.invoices.edit\":true,\"sale.invoices.destroy\":true,\"setting.settings.index\":true,\"setting.settings.edit\":true,\"tag.tags.index\":true,\"tag.tags.create\":true,\"tag.tags.edit\":true,\"tag.tags.destroy\":true,\"translation.translations.index\":true,\"translation.translations.edit\":true,\"translation.translations.import\":true,\"translation.translations.export\":true,\"user.users.index\":true,\"user.users.create\":true,\"user.users.edit\":true,\"user.users.destroy\":true,\"user.roles.index\":true,\"user.roles.create\":true,\"user.roles.edit\":true,\"user.roles.destroy\":true,\"account.api-keys.index\":true,\"account.api-keys.create\":true,\"account.api-keys.destroy\":true,\"workshop.sidebar.group\":true,\"workshop.modules.index\":true,\"workshop.modules.show\":true,\"workshop.modules.update\":true,\"workshop.modules.disable\":true,\"workshop.modules.enable\":true,\"workshop.modules.publish\":true,\"workshop.themes.index\":true,\"workshop.themes.show\":true,\"workshop.themes.publish\":true}', '2018-06-28 09:04:26', 'miya', 'yeh', null, null, null, null, '2018-02-05 10:08:17', '2018-06-28 09:04:26');
INSERT INTO `users` VALUES ('8', '1738956292@qq.com', '$2y$10$LA9wGms38rwy/r025jyGnu0ziD7/WKH7TUBCnt2STaObsCil6gUlO', '', '2018-02-22 10:06:04', 'sdf', 'sdf', null, null, null, null, '2018-02-22 09:39:27', '2018-02-22 10:06:04');
INSERT INTO `users` VALUES ('9', 'alice@qq.com', '$2y$10$uVhZaShd7hLxfGl2XnptD.4d3V7uKXTPyzLgbBiSk4OCUle.FVtK.', '', '2018-06-28 09:04:44', 'alice', 'lin', null, null, null, null, '2018-05-21 02:51:03', '2018-06-28 09:04:44');
INSERT INTO `users` VALUES ('26', '', '$2y$10$NhiKpFMt5zVpBdUY2Q/B/.p0w36U7OO.1JSNTes8v9LQROGZJDvS.', null, '2018-06-28 04:01:06', null, null, 'listen。。', 'qq', 'http://thirdqq.qlogo.cn/qqapp/100367603/9A4DD8F7309B40647C14673A224F5731/100', '9A4DD8F7309B40647C14673A224F5731', '2018-06-28 03:47:54', '2018-06-28 04:01:06');
...
INSERT INTO `user_tokens` VALUES ('3', '9', '9460c912-f32b-4f68-bcc7-a44cce88ddd6', '2018-05-21 02:51:07', '2018-05-21 02:51:07');
INSERT INTO `user_tokens` VALUES ('9', '26', 'f5603d6b-c96c-4fc1-af64-4e24447b42a2', '2018-06-28 03:47:54', '2018-06-28 03:47:54');

-- ----------------------------
-- Table structure for user__useraddresses
-- ----------------------------
DROP TABLE IF EXISTS `user__useraddresses`;
CREATE TABLE `user__useraddresses` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `country_label` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `city` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `city_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- ----------------------------
-- Records of user__useraddresses
-- ----------------------------
INSERT INTO `user__useraddresses` VALUES ('1', 'JUAN', 'YE', 'melody@qq.com', '1234', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '7', '', '', 'Shanghai', null, 'Montana', '200120', '1', '0', '2018-05-22 02:34:20', '2018-05-22 06:33:20');
INSERT INTO `user__useraddresses` VALUES ('2', 'tiantian', 'yeh', 'test123@qq.com', '1234', 'sdff', '7', '', '', 'Shanghai', null, 'Shanghai', '200120', '1', '0', '2018-05-22 02:35:51', '2018-05-22 06:33:24');
INSERT INTO `user__useraddresses` VALUES ('5', 'anni', 'li', 'aa@aa.com', '123', 'sdff', '11', 'Argentina', null, 'Shanghai', null, 'sdf', '200120', '1', '0', '2018-05-22 06:38:09', '2018-05-22 06:38:09');
INSERT INTO `user__useraddresses` VALUES ('6', 'sdf', 'sdf', 'sdf@qq.com', '12', 'sdf', '12', 'United Arab Emirates', null, 'Shanghai', null, 's', '200120', '1', '0', '2018-05-22 06:40:01', '2018-05-22 06:40:01');
INSERT INTO `user__useraddresses` VALUES ('7', 'lucy', 'liu', 'lucy@qq.com', '123', 'assdfsdf', '14', 'Oman', null, 'sdf', null, 'sdf', '200120', '1', '0', '2018-05-22 06:50:50', '2018-05-22 06:50:50');
INSERT INTO `user__useraddresses` VALUES ('8', 'sarah', 'John', 'sarah@qq.com', '123', 'sdfs', '13', 'Aruba', null, 'sdf', null, 'sdf', 'sdf', '1', '0', '2018-05-22 06:59:28', '2018-05-22 06:59:28');
INSERT INTO `user__useraddresses` VALUES ('9', 'shirly', 'john', 'shirly@qq.com', '1233', 'Afghanistan', '10', 'Afghanistan', null, 'sss', null, 'sss', '123', '1', '0', '2018-05-22 07:00:44', '2018-05-22 07:00:44');
INSERT INTO `user__useraddresses` VALUES ('10', 'chris', 'John', 'chris@qq.com', '123', '地址1', '11', 'Argentina', null, 'asssss', null, 'sdf', 'dfdfdf', '1', '0', '2018-05-22 07:02:02', '2018-05-22 07:02:02');
INSERT INTO `user__useraddresses` VALUES ('11', 'callie', 'smith', 'callie@qq.com', '13472740661', 'address for callie smith', '11', 'Argentina', null, 'sdf', null, 'sdf', 'sdf', '1', '0', '2018-05-22 07:09:28', '2018-05-25 06:55:58');
INSERT INTO `user__useraddresses` VALUES ('12', 'carla', 'john', 'carlar@qq.com', '13472740661', 'address for cala john', '8', 'Albania', null, 'sdf', null, 'sdf', 'sdf', '1', '0', '2018-05-22 07:12:30', '2018-05-22 07:12:30');
INSERT INTO `user__useraddresses` VALUES ('13', 'deamon', 'steinfield', 'deamon@qq.com', '13472740661', 'address for deamon steinfield', '10', 'Afghanistan', null, 'sdf', null, 'sdf', 'sdf', '1', '0', '2018-05-22 07:40:12', '2018-05-22 07:40:12');
INSERT INTO `user__useraddresses` VALUES ('14', 'JUAN', 'YE', 'melody@qq.com', '123', 'Room 601 Building 42 Lane 36 ShangPu Rd Pudong District , Shanghai', '8', 'Albania', null, 'Shanghai', null, 'shanghai', '200120', '9', '1', '2018-06-15 07:18:42', '2018-06-15 07:18:42');
