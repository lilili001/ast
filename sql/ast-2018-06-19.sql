...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('2018061505211', '7PG14016217570256', '9', '1', '460.00', '391.00', 'EUR', '9', 'paypal', '', '', '0000-00-00 00:00:00', '2018-06-16 10:08:17', '0000-00-00 00:00:00', '2018-06-15 07:22:06', '', '', '0', '', '', '1', '1', '2018-06-15 07:18:57', '2018-06-15 07:45:59', null);
...
CREATE TABLE `order_refund` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_refund_order_id_unique` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ----------------------------
INSERT INTO `order_shipping` VALUES ('1', '2018061505211', 'ems', '1234', 'SHIPPING20180615922540', '2018-06-15 07:22:09', '2018-06-15 07:22:09');
...
INSERT INTO `persistences` VALUES ('2038', '1', 'OJp3RsXOWqGGPWSow0oZGYwzKmucixcG', '2018-06-13 07:05:14', '2018-06-13 07:05:14');
...
INSERT INTO `shoppingcart` VALUES ('9', 'cart', 'O:29:\"Illuminate\\Support\\Collection\":1:{s:8:\"\0*\0items\";a:0:{}}', null, '0', null, '2018-06-15 07:17:38');
...
INSERT INTO `users` VALUES ('9', 'alice@qq.com', '$2y$10$IXR1wz0p5CQ.YzSwxFCmnue91HX9Ylm7in7eBapQ.YQoAS8/AUwf6', '', '2018-06-15 07:14:30', 'alice', 'lin', '2018-05-21 02:51:03', '2018-06-15 07:14:30');
