...
use Modules\Blog\Events\ProductIsCreating;
use Modules\Blog\Events\ProductIsUpdating;
use Modules\Blog\Events\ProductWasCreated;
use Modules\Blog\Events\ProductWasUpdated;
...
class EloquentPostRepositoryTest extends BaseBlogTestCase
{
    ...
    public function it_triggers_event_when_post_was_created()
    {
        ...
        Event::assertDispatched(ProductWasCreated::class, function ($e) use ($post) {
    ...
    public function it_triggers_event_when_post_is_creating()
    {
        ...
        Event::assertDispatched(ProductIsCreating::class, function ($e) use ($post) {
    ...
    {
        Event::listen(ProductIsCreating::class, function (ProductIsCreating $event) {
    ...
    public function it_triggers_event_when_post_was_updated()
    {
        ...
        Event::assertDispatched(ProductWasUpdated::class, function ($e) use ($post) {
            return $e->post->translate('en')->title === $post->translate('en')->title;
        });
    }
    ...
    public function it_triggers_event_when_post_is_updating()
    {
        ...
        Event::assertDispatched(ProductIsUpdating::class, function ($e) use ($post) {
    ...
    {
        Event::listen(ProductIsUpdating::class, function (ProductIsUpdating $event) {
            $event->setAttributes(['en' => ['title' => 'awesome title']]);
        });
